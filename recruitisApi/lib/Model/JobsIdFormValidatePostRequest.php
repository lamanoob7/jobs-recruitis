...
class JobsIdFormValidatePostRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        ...
        'source_id' => 'int',
        'linkedin' => 'string',
        'cv' => '\RecruitisApi\Model\JobsIdFormValidatePostRequestCvInner[]',
        'gdpr_34' => 'bool',
        'salary' => 'int'
    ];
    ...
    */
     ...
     * Gets cv
     *
     * @return \RecruitisApi\Model\JobsIdFormValidatePostRequestCvInner[]|null
     */
     ...
     * Sets cv
     *
     * @param \RecruitisApi\Model\JobsIdFormValidatePostRequestCvInner[]|null $cv cv
     *
     * @return self
     */
