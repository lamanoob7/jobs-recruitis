<?php
/**
 * EnumsSourcesGet200ResponsePayloadInner
 *
 * PHP version 7.4
 *
 * @category Class
...
/**
 * EnumsSourcesGet200ResponsePayloadInner Class Doc Comment
 *
 * @category Class
 * @package  RecruitisApi
 * @author   OpenAPI Generator team
 ...
 */
class EnumsSourcesGet200ResponsePayloadInner implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = '_enums_sources_get_200_response_payload_inner';
    ...
    */
     ...
     * Sets default_source
     *
     * @param bool|null $default_source default_source
     *
     * @return self
     */
    public function setDefaultSource($default_source)
    {
        if (is_null($default_source)) {
            throw new \InvalidArgumentException('non-nullable default_source cannot be null');
        }
