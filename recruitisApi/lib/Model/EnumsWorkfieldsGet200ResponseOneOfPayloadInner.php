...
class EnumsWorkfieldsGet200ResponseOneOfPayloadInner implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        'id' => 'int',
        'name' => 'string',
        'professions' => '\RecruitisApi\Model\EnumsWorkfieldsGet200ResponseOneOfPayloadInnerProfessionsInner[]'
    ];
    ...
    */
     ...
     * Sets professions
     *
     * @param \RecruitisApi\Model\EnumsWorkfieldsGet200ResponseOneOfPayloadInnerProfessionsInner[]|null $professions professions
     *
     * @return self
     */
