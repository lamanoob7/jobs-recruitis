<?php
/**
 * AnswersGet200ResponseOneOf1PayloadInnerTitle
 *
 * PHP version 7.4
 *
 * @category Class
...
/**
 * AnswersGet200ResponseOneOf1PayloadInnerTitle Class Doc Comment
 *
 * @category Class
 * @package  RecruitisApi
 * @author   OpenAPI Generator team
 ...
 */
class AnswersGet200ResponseOneOf1PayloadInnerTitle implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = '_answers_get_200_response_oneOf_1_payload_inner_title';
    ...
    */
     ...
     * Sets before
     *
     * @param string|null $before Titul před jménem.
     *
     * @return self
     */
     ...
     * Sets after
     *
     * @param string|null $after Titul za jménem.
     *
     * @return self
     */
