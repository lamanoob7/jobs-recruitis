<?php
/**
 * EnumsFlowsGet200ResponsePayloadInner
 *
 * PHP version 7.4
 *
 * @category Class
...
/**
 * EnumsFlowsGet200ResponsePayloadInner Class Doc Comment
 *
 * @category Class
 * @package  RecruitisApi
 * @author   OpenAPI Generator team
 ...
 */
class EnumsFlowsGet200ResponsePayloadInner implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = '_enums_flows_get_200_response_payload_inner';
    ...
    protected static $setters = [
        ...
        'color' => 'setColor',
        'flow_id' => 'setFlowId',
        'flow_label' => 'setFlowLabel',
        'flow_order' => 'setFlowOrder'
    ];
    ...
    protected static $getters = [
        ...
        'color' => 'getColor',
        'flow_id' => 'getFlowId',
        'flow_label' => 'getFlowLabel',
        'flow_order' => 'getFlowOrder'
    ];
    ...
    public function __construct(array $data = [])
    {
        ...
        $this->setIfExists('flow_label', $data, null);
        $this->setIfExists('flow_order', $data, null);
    }
    ...
    */
     ...
     * Sets flow_id
     *
     * @param int|null $flow_id flow_id
     *
     * @return self
     */
     ...
     * @return string|null
     */
    public function getFlowLabel()
    {
        return $this->container['flow_label'];
    }

    /**
     * Sets flow_label
     *
     * @param string|null $flow_label flow_label
     *
     * @return self
     */
    public function setFlowLabel($flow_label)
    {
        if (is_null($flow_label)) {
            throw new \InvalidArgumentException('non-nullable flow_label cannot be null');
        }
        $this->container['flow_label'] = $flow_label;
    ...
    {
        return $this->container['flow_order'];
    }

    /**
     * Sets flow_order
     *
     * @param int|null $flow_order flow_order
     *
     * @return self
     */
    public function setFlowOrder($flow_order)
    {
        if (is_null($flow_order)) {
            throw new \InvalidArgumentException('non-nullable flow_order cannot be null');
        }
        $this->container['flow_order'] = $flow_order;
