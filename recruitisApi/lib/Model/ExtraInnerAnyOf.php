...
/**
 * ExtraInnerAnyOf Class Doc Comment
 *
 * @category Class
 * @package  RecruitisApi
 * @author   OpenAPI Generator team
 ...
 */
class ExtraInnerAnyOf implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'Extra_inner_anyOf';
    ...
    */
    ...
    public function setNote($note)
    {
        ...
        if ((mb_strlen($note) > 800)) {
            throw new \InvalidArgumentException('invalid length for $note when calling ExtraInnerAnyOf., must be smaller than or equal to 800.');
        }
