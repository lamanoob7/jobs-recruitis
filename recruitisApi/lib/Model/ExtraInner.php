 ...
 */
class ExtraInner implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'Extra_inner';
    ...
    public function __construct(array $data = [])
    {
        ...
        $this->setIfExists('answer_tag', $data, null);
    }
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ((mb_strlen($this->container['note']) > 800)) {
            $invalidProperties[] = "invalid value for 'note', the character length must be smaller than or equal to 800.";
        }
        ...
        if ($this->container['answer_tag'] === null) {
            $invalidProperties[] = "'answer_tag' can't be null";
        }
        if ((mb_strlen($this->container['answer_tag']) > 100)) {
            $invalidProperties[] = "invalid value for 'answer_tag', the character length must be smaller than or equal to 100.";
        }
     ...
     * Sets note
     *
     * @param string $note Pokud je určeno, uloží se hodnota jako poznámka. Maximální délka poznámky je 800 znaků.
     *
     * @return self
     */
    public function setNote($note)
    {
        ...
        if ((mb_strlen($note) > 800)) {
            throw new \InvalidArgumentException('invalid length for $note when calling ExtraInner., must be smaller than or equal to 800.');
        }
     ...
     * Sets tag
     *
     * @param string $tag Pokud je určeno, uloží se hodnota jako tag k uchazeči. Maximální délka poznámky je 100 znaků.
     *
     * @return self
     */
    public function setTag($tag)
    {
        ...
        if ((mb_strlen($tag) > 100)) {
            throw new \InvalidArgumentException('invalid length for $tag when calling ExtraInner., must be smaller than or equal to 100.');
        }
    ...
    {
        return $this->container['answer_tag'];
    }

    /**
     * Sets answer_tag
     *
     * @param string $answer_tag Pokud je určeno, uloží se hodnota jako tag vázaný k odpovědi. Maximální délka poznámky je 100 znaků.
     *
     * @return self
     */
    public function setAnswerTag($answer_tag)
    {
        if (is_null($answer_tag)) {
            throw new \InvalidArgumentException('non-nullable answer_tag cannot be null');
        }
        if ((mb_strlen($answer_tag) > 100)) {
            throw new \InvalidArgumentException('invalid length for $answer_tag when calling ExtraInner., must be smaller than or equal to 100.');
        }

        $this->container['answer_tag'] = $answer_tag;
