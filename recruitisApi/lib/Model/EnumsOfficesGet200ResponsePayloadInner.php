<?php
/**
 * EnumsOfficesGet200ResponsePayloadInner
 *
 * PHP version 7.4
 *
 * @category Class
...
/**
 * EnumsOfficesGet200ResponsePayloadInner Class Doc Comment
 *
 * @category Class
 * @package  RecruitisApi
 * @author   OpenAPI Generator team
 ...
 */
class EnumsOfficesGet200ResponsePayloadInner implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = '_enums_offices_get_200_response_payload_inner';
    ...
    public function __construct(array $data = [])
    {
        ...
        $this->setIfExists('psc', $data, null);
    ...
    */
    ...
    {
        if (is_null($psc)) {
            throw new \InvalidArgumentException('non-nullable psc cannot be null');
        }
