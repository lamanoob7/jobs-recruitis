...
/**
 * AnswersPostRequestSalary Class Doc Comment
 *
 * @category Class
 * @description Požadovaný plat
 * @package  RecruitisApi
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 * @implements \ArrayAccess<string, mixed>
 */
class AnswersPostRequestSalary implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = '_answers_post_request_salary';
    ...
    */
     ...
     * Sets type
     *
     * @param int|null $type | X | Typ pracovního poměru    | | - | ------------------------ | | 0 | Práce na plný úvazek     | | 1 | Práce na zkrácený úvazek | | 2 | Práce na živnost         | | 3 | Práce přes internet      | | 4 | Práce doma               | | 5 | Krátkodobá práce         | | 6 | Brigáda                  |
     *
     * @return self
     */
