...
/**
 * ExtraInnerAnyOf1 Class Doc Comment
 *
 * @category Class
 * @package  RecruitisApi
 * @author   OpenAPI Generator team
 ...
 */
class ExtraInnerAnyOf1 implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'Extra_inner_anyOf_1';
    ...
    */
    ...
    public function setTag($tag)
    {
        ...
        if ((mb_strlen($tag) > 100)) {
            throw new \InvalidArgumentException('invalid length for $tag when calling ExtraInnerAnyOf1., must be smaller than or equal to 100.');
        }
