...
class JobReferralsInner implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        'rules' => 'string',
        'activity' => 'string',
        'reward' => '\RecruitisApi\Model\JobReferralsInnerReward'
    ];
    ...
    */
     ...
     * Gets reward
     *
     * @return \RecruitisApi\Model\JobReferralsInnerReward|null
     */
     ...
     * Sets reward
     *
     * @param \RecruitisApi\Model\JobReferralsInnerReward|null $reward reward
     *
     * @return self
     */
