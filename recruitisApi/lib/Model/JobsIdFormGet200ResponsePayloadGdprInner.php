<?php
/**
 * JobsIdFormGet200ResponsePayloadGdprInner
 *
 * PHP version 7.4
 *
 * @category Class
...
/**
 * JobsIdFormGet200ResponsePayloadGdprInner Class Doc Comment
 *
 * @category Class
 * @package  RecruitisApi
 * @author   OpenAPI Generator team
 ...
 */
class JobsIdFormGet200ResponsePayloadGdprInner implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = '_jobs__id__form_get_200_response_payload_gdpr_inner';
    ...
    protected static $setters = [
        'id' => 'setId',
        'title' => 'setTitle',
        'text_short' => 'setTextShort',
        'text_long' => 'setTextLong',
        'type' => 'setType',
        'source' => 'setSource'
    ];
    ...
    protected static $getters = [
        'id' => 'getId',
        'title' => 'getTitle',
        'text_short' => 'getTextShort',
        'text_long' => 'getTextLong',
        'type' => 'getType',
        'source' => 'getSource'
    ];
    ...
    public function __construct(array $data = [])
    {
        ...
        $this->setIfExists('text_short', $data, null);
        $this->setIfExists('text_long', $data, null);
    ...
    */
    ...
    {
        return $this->container['text_short'];
    }

    /**
     * Sets text_short
     *
     * @param string|null $text_short text_short
     *
     * @return self
     */
    public function setTextShort($text_short)
    {
        if (is_null($text_short)) {
            throw new \InvalidArgumentException('non-nullable text_short cannot be null');
        }
        $this->container['text_short'] = $text_short;
    ...
    {
        return $this->container['text_long'];
    }

    /**
     * Sets text_long
     *
     * @param string|null $text_long text_long
     *
     * @return self
     */
    public function setTextLong($text_long)
    {
        if (is_null($text_long)) {
            throw new \InvalidArgumentException('non-nullable text_long cannot be null');
        }
        $this->container['text_long'] = $text_long;
