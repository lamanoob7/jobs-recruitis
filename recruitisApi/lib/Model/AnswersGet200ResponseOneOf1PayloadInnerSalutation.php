<?php
/**
 * AnswersGet200ResponseOneOf1PayloadInnerSalutation
 *
 * PHP version 7.4
 *
 * @category Class
...
/**
 * AnswersGet200ResponseOneOf1PayloadInnerSalutation Class Doc Comment
 *
 * @category Class
 * @package  RecruitisApi
 * @author   OpenAPI Generator team
 ...
 */
class AnswersGet200ResponseOneOf1PayloadInnerSalutation implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = '_answers_get_200_response_oneOf_1_payload_inner_salutation';
    ...
    */
     ...
     * Sets first_name
     *
     * @param string|null $first_name Oslovení kandidáta - jméno.
     *
     * @return self
     */
     ...
     * Sets last_name
     *
     * @param string|null $last_name Oslovení kandidáta - příjmení.
     *
     * @return self
     */
