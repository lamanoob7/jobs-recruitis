...
/**
 * CandidatesIdCommunicationPostRequest Class Doc Comment
 *
 * @category Class
 * @package  RecruitisApi
 * @author   OpenAPI Generator team
 ...
 */
class CandidatesIdCommunicationPostRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = '_candidates__id__communication_post_request';
    ...
    */
     ...
     * Sets sender
     *
     * @param string|null $sender Textová podoba odesílatele (jméno, email, telefonní číslo (SMS)), pokud nebude vyplněno, použijí se data vázaná na `author_id`.
     *
     * @return self
     */
     ...
     * Sets recipient
     *
     * @param string|null $recipient viz. parametr `sender`
     *
     * @return self
     */
