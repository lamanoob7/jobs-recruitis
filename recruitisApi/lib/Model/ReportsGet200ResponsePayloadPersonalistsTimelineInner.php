<?php
/**
 * ReportsGet200ResponsePayloadPersonalistsTimelineInner
 *
 * PHP version 7.4
 *
 * @category Class
...
/**
 * ReportsGet200ResponsePayloadPersonalistsTimelineInner Class Doc Comment
 *
 * @category Class
 * @package  RecruitisApi
 * @author   OpenAPI Generator team
 ...
 */
class ReportsGet200ResponsePayloadPersonalistsTimelineInner implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = '_reports_get_200_response_payload_personalists_timeline_inner';
    ...
    protected static $openAPITypes = [
        ...
        'action_detailed_description' => 'string',
        'job_id' => 'int',
        'job_title' => 'string'
    ];
    ...
    protected static $openAPIFormats = [
        ...
        'action_detailed_description' => null,
        'job_id' => null,
        'job_title' => null
    ];
    ...
    protected static $openAPINullables = [
        ...
        'action_detailed_description' => false,
        'job_id' => false,
        'job_title' => false
    ];
    ...
    protected static $attributeMap = [
        ...
        'action_detailed_description' => 'ActionDetailedDescription',
        'job_id' => 'JobID',
        'job_title' => 'JobTitle'
    ];
    ...
    protected static $setters = [
        ...
        'action_detailed_description' => 'setActionDetailedDescription',
        'job_id' => 'setJobId',
    ...
    protected static $getters = [
        ...
        'action_detailed_description' => 'getActionDetailedDescription',
        'job_id' => 'getJobId',
    ...
    public function __construct(array $data = [])
    {
        ...
        $this->setIfExists('action_detailed_description', $data, null);
    ...
    */
    ...
    /**
     * Gets action_detailed_description
     *
     * @return string|null
     */
    public function getActionDetailedDescription()
    {
        return $this->container['action_detailed_description'];
    }

    /**
     * Sets action_detailed_description
     *
     * @param string|null $action_detailed_description action_detailed_description
     *
     * @return self
     */
    public function setActionDetailedDescription($action_detailed_description)
    {
        if (is_null($action_detailed_description)) {
            throw new \InvalidArgumentException('non-nullable action_detailed_description cannot be null');
        }
        $this->container['action_detailed_description'] = $action_detailed_description;
