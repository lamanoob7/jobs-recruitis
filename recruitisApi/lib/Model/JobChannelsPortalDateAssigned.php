...
/**
 * JobChannelsPortalDateAssigned Class Doc Comment
 *
 * @category Class
 * @package  RecruitisApi
 * @author   OpenAPI Generator team
 ...
 */
class JobChannelsPortalDateAssigned implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'Job_channels_portal_date_assigned';
