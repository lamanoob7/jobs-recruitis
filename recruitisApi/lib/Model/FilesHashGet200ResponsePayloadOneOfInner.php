<?php
/**
 * FilesHashGet200ResponsePayloadOneOfInner
 *
 * PHP version 7.4
 *
 * @category Class
...
/**
 * FilesHashGet200ResponsePayloadOneOfInner Class Doc Comment
 *
 * @category Class
 * @package  RecruitisApi
 * @author   OpenAPI Generator team
 ...
 */
class FilesHashGet200ResponsePayloadOneOfInner implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = '_files__hash__get_200_response_payload_oneOf_inner';
    ...
    */
     ...
     * Sets name
     *
     * @param string|null $name Název souboru i s příponou.
     *
     * @return self
     */
     ...
     * Sets size
     *
     * @param float|null $size Velikost souboru v kB (na 2 desetinná místa).
     *
     * @return self
     */
     ...
     * Sets content
     *
     * @param string|null $content Znění souboru v Base64.
     *
     * @return self
     */
