...
class GDPR implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'GDPR';
    ...
    {
        $this->setIfExists('date_expiration', $data, null);
        $this->setIfExists('source', $data, 'manual');
    }
    ...
    */
     ...
     *
     * @param \DateTime|null $date_expiration Formát YYYY-MM-DD.
     *
     * @return self
     */
    public function setDateExpiration($date_expiration)
    {
        if (is_null($date_expiration)) {
            throw new \InvalidArgumentException('non-nullable date_expiration cannot be null');
        }
     ...
     * Sets source
     *
     * @param string|null $source Stringové označení, odkud byl GDPR souhlas pořízen.
     *
     * @return self
     */
