<?php
/**
 * AnswersGet200ResponseOneOf1PayloadInnerSource
 *
 * PHP version 7.4
 *
 * @category Class
...
/**
 * AnswersGet200ResponseOneOf1PayloadInnerSource Class Doc Comment
 *
 * @category Class
 * @package  RecruitisApi
 * @author   OpenAPI Generator team
 ...
 */
class AnswersGet200ResponseOneOf1PayloadInnerSource implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = '_answers_get_200_response_oneOf_1_payload_inner_source';
    ...
    */
     ...
     * Sets name
     *
     * @param string|null $name Název zdroje, ke kterému se odpověď vztahuje.
     *
     * @return self
     */
     ...
     * Sets type
     *
     * @param string|null $type Typ zdroje. Například jestli je to systémový email, api aj.
     *
     * @return self
     */
