<?php
/**
 * ChecklistsAnswerIdItemItemIdStatePutRequest
 *
 * PHP version 7.4
 *
 * @category Class
...
/**
 * ChecklistsAnswerIdItemItemIdStatePutRequest Class Doc Comment
 *
 * @category Class
 * @package  RecruitisApi
 * @author   OpenAPI Generator team
 ...
 */
class ChecklistsAnswerIdItemItemIdStatePutRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = '_checklists__answer_id__item__item_id__state_put_request';
    ...
    */
     ...
     * Sets state
     *
     * @param int $state číselník stavů:     * 1 = UNCHECKED;     * 2 = CHECKED;     * 3 = REJECTED;
     *
     * @return self
     */
