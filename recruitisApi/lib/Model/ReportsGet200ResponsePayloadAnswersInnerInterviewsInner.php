<?php
/**
 * ReportsGet200ResponsePayloadAnswersInnerInterviewsInner
 *
 * PHP version 7.4
 *
 * @category Class
...
/**
 * ReportsGet200ResponsePayloadAnswersInnerInterviewsInner Class Doc Comment
 *
 * @category Class
 * @package  RecruitisApi
 * @author   OpenAPI Generator team
 ...
 */
class ReportsGet200ResponsePayloadAnswersInnerInterviewsInner implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = '_reports_get_200_response_payload_answers_inner_Interviews_inner';
    ...
    protected static $setters = [
        ...
        'threats' => 'setThreats',
        'note' => 'setNote',
        'available_since' => 'setAvailableSince',
        'ending_reason' => 'setEndingReason',
        'salary_demand' => 'setSalaryDemand'
    ];
    ...
    protected static $getters = [
        ...
        'threats' => 'getThreats',
        'note' => 'getNote',
        'available_since' => 'getAvailableSince',
        'ending_reason' => 'getEndingReason',
        'salary_demand' => 'getSalaryDemand'
    ];
    ...
    {
        $this->setIfExists('strengths', $data, null);
        $this->setIfExists('weaknesses', $data, null);
        $this->setIfExists('opportunities', $data, null);
        $this->setIfExists('threats', $data, null);
        $this->setIfExists('note', $data, null);
        $this->setIfExists('available_since', $data, null);
        $this->setIfExists('ending_reason', $data, null);
        $this->setIfExists('salary_demand', $data, null);
    }
    ...
    */
    ...
    {
        return $this->container['strengths'];
    }

    /**
     * Sets strengths
     *
     * @param string|null $strengths strengths
     *
     * @return self
     */
    public function setStrengths($strengths)
    {
        if (is_null($strengths)) {
            throw new \InvalidArgumentException('non-nullable strengths cannot be null');
        }
        $this->container['strengths'] = $strengths;
     ...
     * Sets weaknesses
     *
     * @param string|null $weaknesses weaknesses
     *
     * @return self
     */
     ...
     * Sets opportunities
     *
     * @param string|null $opportunities opportunities
     *
     * @return self
     */
     ...
     * Sets threats
     *
     * @param string|null $threats threats
     *
     * @return self
     */
    ...
    {
        if (is_null($threats)) {
            throw new \InvalidArgumentException('non-nullable threats cannot be null');
        }
    ...
    /**
     * Gets available_since
     *
     * @return string|null
     */
    public function getAvailableSince()
    {
        return $this->container['available_since'];
    }

    /**
     * Sets available_since
     *
     * @param string|null $available_since available_since
     *
     * @return self
     */
    public function setAvailableSince($available_since)
    {
        if (is_null($available_since)) {
            throw new \InvalidArgumentException('non-nullable available_since cannot be null');
        }
        $this->container['available_since'] = $available_since;
    ...
    {
        return $this->container['ending_reason'];
    }

    /**
     * Sets ending_reason
     *
     * @param string|null $ending_reason ending_reason
     *
     * @return self
     */
    public function setEndingReason($ending_reason)
    {
        if (is_null($ending_reason)) {
            throw new \InvalidArgumentException('non-nullable ending_reason cannot be null');
        }
        $this->container['ending_reason'] = $ending_reason;
     ...
     * @return int|null
     */
    public function getSalaryDemand()
    {
        return $this->container['salary_demand'];
    }

    /**
     * Sets salary_demand
     *
     * @param int|null $salary_demand salary_demand
     *
     * @return self
     */
    public function setSalaryDemand($salary_demand)
    {
        if (is_null($salary_demand)) {
            throw new \InvalidArgumentException('non-nullable salary_demand cannot be null');
        }
        $this->container['salary_demand'] = $salary_demand;
