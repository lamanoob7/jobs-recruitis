<?php
/**
 * AnswersAnswerIdExportPutRequest
 *
 * PHP version 7.4
 *
 * @category Class
...
/**
 * AnswersAnswerIdExportPutRequest Class Doc Comment
 *
 * @category Class
 * @package  RecruitisApi
 * @author   OpenAPI Generator team
 ...
 */
class AnswersAnswerIdExportPutRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = '_answers__answer_id__export_put_request';
    ...
    */
     ...
     * Sets status
     *
     * @param int $status Bitmaska, hodnoty v řadě 1,2,4,8,16,..
     *
     * @return self
     */
