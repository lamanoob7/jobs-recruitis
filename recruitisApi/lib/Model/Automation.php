...
class Automation implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        'id' => 'int',
        'event_name' => 'string',
        'event_params' => '\RecruitisApi\Model\AutomationEventParams',
        'pipeline' => '\RecruitisApi\Model\AutomationPipelineInnerInner[][]',
        'stopped' => 'bool',
        'author_id' => 'int',
        'created_at' => 'string',
        'updated_at' => 'string'
    ...
    */
     ...
     * Gets event_params
     *
     * @return \RecruitisApi\Model\AutomationEventParams|null
     */
     ...
     * Sets event_params
     *
     * @param \RecruitisApi\Model\AutomationEventParams|null $event_params event_params
     *
     * @return self
     */
     ...
     * Gets pipeline
     *
     * @return \RecruitisApi\Model\AutomationPipelineInnerInner[][]|null
     */
     ...
     * Sets pipeline
     *
     * @param \RecruitisApi\Model\AutomationPipelineInnerInner[][]|null $pipeline pipeline
     *
     * @return self
     */
