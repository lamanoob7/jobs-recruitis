<?php
/**
 * AnswersAnswerIdExportPut200ResponsePayload
 *
 * PHP version 7.4
 *
 * @category Class
...
/**
 * AnswersAnswerIdExportPut200ResponsePayload Class Doc Comment
 *
 * @category Class
 * @package  RecruitisApi
 * @author   OpenAPI Generator team
 ...
 */
class AnswersAnswerIdExportPut200ResponsePayload implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = '_answers__answer_id__export_put_200_response_payload';
    ...
    protected static $openAPIFormats = [
        'answer_id' => null,
        'exported_status' => null,
        'exported_date' => 'date-time'
    ];
    ...
    protected static $setters = [
        ...
        'exported_status' => 'setExportedStatus',
        'exported_date' => 'setExportedDate'
    ];
    ...
    protected static $getters = [
        ...
        'exported_status' => 'getExportedStatus',
        'exported_date' => 'getExportedDate'
    ];
    ...
    public function __construct(array $data = [])
    {
        ...
        $this->setIfExists('exported_status', $data, null);
        $this->setIfExists('exported_date', $data, null);
    }
    ...
    */
    ...
    /**
     * Gets exported_status
     *
     * @return int|null
     */
    public function getExportedStatus()
    {
        return $this->container['exported_status'];
    }

    /**
     * Sets exported_status
     *
     * @param int|null $exported_status exported_status
     *
     * @return self
     */
    public function setExportedStatus($exported_status)
    {
        if (is_null($exported_status)) {
            throw new \InvalidArgumentException('non-nullable exported_status cannot be null');
        }
        $this->container['exported_status'] = $exported_status;
    ...
    {
        return $this->container['exported_date'];
    }

    /**
     * Sets exported_date
     *
     * @param \DateTime|null $exported_date exported_date
     *
     * @return self
     */
    public function setExportedDate($exported_date)
    {
        if (is_null($exported_date)) {
            throw new \InvalidArgumentException('non-nullable exported_date cannot be null');
        }
        $this->container['exported_date'] = $exported_date;
