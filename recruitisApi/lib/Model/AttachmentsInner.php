...
/**
 * AttachmentsInner Class Doc Comment
 *
 * @category Class
 * @package  RecruitisApi
 * @author   OpenAPI Generator team
 ...
 */
class AttachmentsInner implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'Attachments_inner';
    ...
    */
     ...
     * Sets path
     *
     * @param string $path Atribut path je vyžadován. Ujistěte se, že je soubor dostupný z jiné domény.
     *
     * @return self
     */
     ...
     * Sets filename
     *
     * @param string $filename Název souboru. Musí obsahovat koncovku a čitelné znaky. Mezery budou nahrazeny podtržítkem.
     *
     * @return self
     */
     ...
     * Sets base64
     *
     * @param string $base64 Atribut base64 je vyžadován. Data souboru v base64 formátu.
     *
     * @return self
     */
