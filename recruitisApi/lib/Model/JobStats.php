...
class JobStats implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        'answers' => 'int',
        'views' => 'int',
        'flow_answers' => '\RecruitisApi\Model\JobStatsFlowAnswersInner[]'
    ];
    ...
    */
     ...
     * Gets flow_answers
     *
     * @return \RecruitisApi\Model\JobStatsFlowAnswersInner[]|null
     */
     ...
     * Sets flow_answers
     *
     * @param \RecruitisApi\Model\JobStatsFlowAnswersInner[]|null $flow_answers flow_answers
     *
     * @return self
     */
