<?php
/**
 * AnswersAnswerIdGet200ResponsePayloadSignJob
 *
 * PHP version 7.4
 *
 * @category Class
...
/**
 * AnswersAnswerIdGet200ResponsePayloadSignJob Class Doc Comment
 *
 * @category Class
 * @package  RecruitisApi
 * @author   OpenAPI Generator team
 ...
 */
class AnswersAnswerIdGet200ResponsePayloadSignJob implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = '_answers__answer_id__get_200_response_payload_sign_job';
    ...
    protected static $attributeMap = [
        'job_title' => 'job_title',
        'job_source_site' => 'job_source_site'
    ];
    ...
    protected static $setters = [
        ...
        'job_source_site' => 'setJobSourceSite'
    ];
    ...
    protected static $getters = [
        ...
        'job_source_site' => 'getJobSourceSite'
    ];
    ...
    public function __construct(array $data = [])
    {
        ...
        $this->setIfExists('job_source_site', $data, null);
    }
    ...
    */
    ...
    /**
     * Gets job_source_site
     *
     * @return string|null
     * @deprecated
     */
    public function getJobSourceSite()
    {
        return $this->container['job_source_site'];
    }

    /**
     * Sets job_source_site
     *
     * @param string|null $job_source_site portál, na kterém byl inzerát vytvořen.
     *
     * @return self
     * @deprecated
     */
    public function setJobSourceSite($job_source_site)
    {
        if (is_null($job_source_site)) {
            throw new \InvalidArgumentException('non-nullable job_source_site cannot be null');
        }
        $this->container['job_source_site'] = $job_source_site;
