...
/**
 * JobsIdFormValidatePost404ResponseMeta Class Doc Comment
 *
 * @category Class
 * @package  RecruitisApi
 * @author   OpenAPI Generator team
 ...
 */
class JobsIdFormValidatePost404ResponseMeta implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = '_jobs__id__form_validate_post_404_response_meta';
    ...
    */
     ...
     * Sets message
     *
     * @param string|null $message Bližší popis chyby.
     *
     * @return self
     */
