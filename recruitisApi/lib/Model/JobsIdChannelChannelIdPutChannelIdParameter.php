<?php
/**
 * JobsIdChannelChannelIdPutChannelIdParameter
 *
 * PHP version 7.4
 *
 * @category Class
...
/**
 * JobsIdChannelChannelIdPutChannelIdParameter Class Doc Comment
 *
 * @category Class
 * @package  RecruitisApi
 * @author   OpenAPI Generator team
 ...
 */
class JobsIdChannelChannelIdPutChannelIdParameter implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = '_jobs__id__channel__channel_id__put_channel_id_parameter';
