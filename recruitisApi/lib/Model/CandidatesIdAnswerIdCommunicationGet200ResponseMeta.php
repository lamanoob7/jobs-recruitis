<?php
/**
 * CandidatesIdAnswerIdCommunicationGet200ResponseMeta
 *
 * PHP version 7.4
 *
 * @category Class
...
/**
 * CandidatesIdAnswerIdCommunicationGet200ResponseMeta Class Doc Comment
 *
 * @category Class
 * @package  RecruitisApi
 * @author   OpenAPI Generator team
 ...
 */
class CandidatesIdAnswerIdCommunicationGet200ResponseMeta implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = '_candidates__id___answer_id__communication_get_200_response_meta';
    ...
    protected static $setters = [
        ...
        'message' => 'setMessage',
        'entries_from' => 'setEntriesFrom',
        'entries_to' => 'setEntriesTo',
        'entries_total' => 'setEntriesTotal',
        'entries_sum' => 'setEntriesSum'
    ];
    ...
    protected static $getters = [
        ...
        'message' => 'getMessage',
        'entries_from' => 'getEntriesFrom',
        'entries_to' => 'getEntriesTo',
        'entries_total' => 'getEntriesTotal',
        'entries_sum' => 'getEntriesSum'
    ];
    ...
    public function __construct(array $data = [])
    {
        ...
        $this->setIfExists('entries_from', $data, null);
        $this->setIfExists('entries_to', $data, null);
        $this->setIfExists('entries_total', $data, null);
        $this->setIfExists('entries_sum', $data, null);
    }
    ...
    */
     ...
     * @return int|null
     */
    public function getEntriesFrom()
    {
        return $this->container['entries_from'];
    }

    /**
     * Sets entries_from
     *
     * @param int|null $entries_from entries_from
     *
     * @return self
     */
    public function setEntriesFrom($entries_from)
    {
        if (is_null($entries_from)) {
            throw new \InvalidArgumentException('non-nullable entries_from cannot be null');
        }
        $this->container['entries_from'] = $entries_from;
     ...
     * @return int|null
     */
    public function getEntriesTo()
    {
        return $this->container['entries_to'];
    }

    /**
     * Sets entries_to
     *
     * @param int|null $entries_to entries_to
     *
     * @return self
     */
    public function setEntriesTo($entries_to)
    {
        if (is_null($entries_to)) {
            throw new \InvalidArgumentException('non-nullable entries_to cannot be null');
        }
        $this->container['entries_to'] = $entries_to;
    ...
    {
        return $this->container['entries_total'];
    }

    /**
     * Sets entries_total
     *
     * @param int|null $entries_total entries_total
     *
     * @return self
     */
    public function setEntriesTotal($entries_total)
    {
        if (is_null($entries_total)) {
            throw new \InvalidArgumentException('non-nullable entries_total cannot be null');
        }
        $this->container['entries_total'] = $entries_total;
     ...
     * @return int|null
     */
    public function getEntriesSum()
    {
        return $this->container['entries_sum'];
    }

    /**
     * Sets entries_sum
     *
     * @param int|null $entries_sum entries_sum
     *
     * @return self
     */
    public function setEntriesSum($entries_sum)
    {
        if (is_null($entries_sum)) {
            throw new \InvalidArgumentException('non-nullable entries_sum cannot be null');
        }
        $this->container['entries_sum'] = $entries_sum;
