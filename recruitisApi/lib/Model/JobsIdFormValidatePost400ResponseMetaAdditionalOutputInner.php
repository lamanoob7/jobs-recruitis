<?php
/**
 * JobsIdFormValidatePost400ResponseMetaAdditionalOutputInner
 *
 * PHP version 7.4
 *
 * @category Class
...
/**
 * JobsIdFormValidatePost400ResponseMetaAdditionalOutputInner Class Doc Comment
 *
 * @category Class
 * @package  RecruitisApi
 * @author   OpenAPI Generator team
 ...
 */
class JobsIdFormValidatePost400ResponseMetaAdditionalOutputInner implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = '_jobs__id__form_validate_post_400_response_meta_additional_output_inner';
    ...
    */
     ...
     * Sets message
     *
     * @param string|null $message Chybová hláška při nezdařené validaci.
     *
     * @return self
     */
     ...
     * Sets status
     *
     * @param string|null $status V případě nezdařené validace vždy ERROR.
     *
     * @return self
     */
     ...
     * Sets code
     *
     * @param string|null $code Název formulářového prvku (input.name).
     *
     * @return self
     */
