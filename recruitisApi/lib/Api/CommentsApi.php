...
class CommentsApi
{
     ...
     * Delete comment
     *
     * @param  int $id ID poznámky (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['commentsDelete'] to see the possible values for this operation
     *
     * @throws \RecruitisApi\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return mixed[]|int|object|null|\RecruitisApi\Model\CommentsDelete200Response|\RecruitisApi\Model\LoginPut401Response|\RecruitisApi\Model\JobsIdGet404Response
     */
    public function commentsDelete($id, string $contentType = self::contentTypes['commentsDelete'][0])
    {
        list($response) = $this->commentsDeleteWithHttpInfo($id, $contentType);
        return $response;
    }
     ...
     * @throws \RecruitisApi\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array<mixed[]|int|object|null|\RecruitisApi\Model\CommentsDelete200Response|\RecruitisApi\Model\LoginPut401Response|\RecruitisApi\Model\JobsIdGet404Response> array of \RecruitisApi\Model\CommentsDelete200Response|\RecruitisApi\Model\LoginPut401Response|\RecruitisApi\Model\JobsIdGet404Response, HTTP status code, HTTP response headers (array of strings)
     */
    public function commentsDeleteWithHttpInfo($id, string $contentType = self::contentTypes['commentsDelete'][0])
    {
        $request = $this->commentsDeleteRequest($id, $contentType);
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\RecruitisApi\Model\CommentsDelete200Response' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\RecruitisApi\Model\CommentsDelete200Response' !== 'string') {
                            try {
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\RecruitisApi\Model\CommentsDelete200Response', []),
            ...
            $returnType = '\RecruitisApi\Model\CommentsDelete200Response';
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\RecruitisApi\Model\CommentsDelete200Response',
     ...
     */
    public function commentsDeleteAsync($id, string $contentType = self::contentTypes['commentsDelete'][0])
    {
        return $this->commentsDeleteAsyncWithHttpInfo($id, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function commentsDeleteAsyncWithHttpInfo($id, string $contentType = self::contentTypes['commentsDelete'][0])
    {
        $returnType = '\RecruitisApi\Model\CommentsDelete200Response';
        $request = $this->commentsDeleteRequest($id, $contentType);
     ...
     */
    public function commentsDeleteRequest($id, string $contentType = self::contentTypes['commentsDelete'][0])
    {
     ...
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['commentsGet'] to see the possible values for this operation
     *
     * @throws \RecruitisApi\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return mixed[]|int|object|null|\RecruitisApi\Model\CommentsGet200Response|\RecruitisApi\Model\LoginPut401Response|\RecruitisApi\Model\JobsIdGet404Response
     */
    public function commentsGet($field, string $contentType = self::contentTypes['commentsGet'][0])
    {
        list($response) = $this->commentsGetWithHttpInfo($field, $contentType);
        return $response;
    }

    /**
     * Operation commentsGetWithHttpInfo
     *
     * Get comments
     *
     ...
     * @throws \RecruitisApi\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array<mixed[]|int|object|null|\RecruitisApi\Model\CommentsGet200Response|\RecruitisApi\Model\LoginPut401Response|\RecruitisApi\Model\JobsIdGet404Response> array of \RecruitisApi\Model\CommentsGet200Response|\RecruitisApi\Model\LoginPut401Response|\RecruitisApi\Model\JobsIdGet404Response, HTTP status code, HTTP response headers (array of strings)
     */
    public function commentsGetWithHttpInfo($field, string $contentType = self::contentTypes['commentsGet'][0])
    {
        $request = $this->commentsGetRequest($field, $contentType);
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\RecruitisApi\Model\CommentsGet200Response' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\RecruitisApi\Model\CommentsGet200Response' !== 'string') {
                            try {
                                if(defined('JSON_THROW_ON_ERROR')){
                                    $content = json_decode($content, false, 512, JSON_THROW_ON_ERROR);
                                } else {
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\RecruitisApi\Model\CommentsGet200Response', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                case 401:
            ...
            $returnType = '\RecruitisApi\Model\CommentsGet200Response';
            if ($returnType === '\SplFileObject') {
                $content = $response->getBody(); //stream goes to serializer
            } else {
                $content = (string) $response->getBody();
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\RecruitisApi\Model\CommentsGet200Response',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function commentsGetAsync($field, string $contentType = self::contentTypes['commentsGet'][0])
    {
        return $this->commentsGetAsyncWithHttpInfo($field, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation commentsGetAsyncWithHttpInfo
     *
     * Get comments
     *
     * @param  string $field (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function commentsGetAsyncWithHttpInfo($field, string $contentType = self::contentTypes['commentsGet'][0])
    {
        $returnType = '\RecruitisApi\Model\CommentsGet200Response';
        $request = $this->commentsGetRequest($field, $contentType);
    ...
    /**
     * Create request for operation 'commentsGet'
     *
     * @param  string $field (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['commentsGet'] to see the possible values for this operation
     *
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function commentsGetRequest($field, string $contentType = self::contentTypes['commentsGet'][0])
    {

        // verify the required parameter 'field' is set
        if ($field === null || (is_array($field) && count($field) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $field when calling commentsGet'
            );
        }
    ...
    /**
     * Operation commentsPost
     *
     * Add comment
     *
     * @param  \RecruitisApi\Model\CommentsPostRequest $comments_post_request comments_post_request (optional)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['commentsPost'] to see the possible values for this operation
     *
     * @throws \RecruitisApi\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return mixed[]|int|object|null|\RecruitisApi\Model\CommentsPost201Response|\RecruitisApi\Model\LoginPut401Response
     */
    public function commentsPost($comments_post_request = null, string $contentType = self::contentTypes['commentsPost'][0])
    {
        list($response) = $this->commentsPostWithHttpInfo($comments_post_request, $contentType);
        return $response;
    }

    /**
     * Operation commentsPostWithHttpInfo
     *
     * Add comment
     *
     * @param  \RecruitisApi\Model\CommentsPostRequest $comments_post_request (optional)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['commentsPost'] to see the possible values for this operation
     *
     * @throws \RecruitisApi\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array<mixed[]|int|object|null|\RecruitisApi\Model\CommentsPost201Response|\RecruitisApi\Model\LoginPut401Response> array of \RecruitisApi\Model\CommentsPost201Response|\RecruitisApi\Model\LoginPut401Response, HTTP status code, HTTP response headers (array of strings)
     */
    public function commentsPostWithHttpInfo($comments_post_request = null, string $contentType = self::contentTypes['commentsPost'][0])
    {
        $request = $this->commentsPostRequest($comments_post_request, $contentType);
        ...
        try {
            ...
            switch($statusCode) {
                case 201:
                    if ('\RecruitisApi\Model\CommentsPost201Response' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\RecruitisApi\Model\CommentsPost201Response' !== 'string') {
                            try {
                                if(defined('JSON_THROW_ON_ERROR')){
                                    $content = json_decode($content, false, 512, JSON_THROW_ON_ERROR);
                                } else {
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\RecruitisApi\Model\CommentsPost201Response', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                case 401:
            ...
            $returnType = '\RecruitisApi\Model\CommentsPost201Response';
            if ($returnType === '\SplFileObject') {
                $content = $response->getBody(); //stream goes to serializer
            } else {
                $content = (string) $response->getBody();
            ...
            switch ($e->getCode()) {
                case 201:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\RecruitisApi\Model\CommentsPost201Response',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function commentsPostAsync($comments_post_request = null, string $contentType = self::contentTypes['commentsPost'][0])
    {
        return $this->commentsPostAsyncWithHttpInfo($comments_post_request, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation commentsPostAsyncWithHttpInfo
     *
     * Add comment
     *
     * @param  \RecruitisApi\Model\CommentsPostRequest $comments_post_request (optional)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function commentsPostAsyncWithHttpInfo($comments_post_request = null, string $contentType = self::contentTypes['commentsPost'][0])
    {
        $returnType = '\RecruitisApi\Model\CommentsPost201Response';
        $request = $this->commentsPostRequest($comments_post_request, $contentType);
    ...
    /**
     * Create request for operation 'commentsPost'
     *
     * @param  \RecruitisApi\Model\CommentsPostRequest $comments_post_request (optional)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['commentsPost'] to see the possible values for this operation
     *
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function commentsPostRequest($comments_post_request = null, string $contentType = self::contentTypes['commentsPost'][0])
    {
        ...
        // for model (json/xml)
        if (isset($comments_post_request)) {
            if (stripos($headers['Content-Type'], 'application/json') !== false) {
                # if Content-Type contains "application/json", json_encode the body
                if(PHP_VERSION_ID < 70200){
                    $httpBody = \GuzzleHttp\json_encode(ObjectSerializer::sanitizeForSerialization($comments_post_request));
                } else {
                    $httpBody = \GuzzleHttp\Utils::jsonEncode(ObjectSerializer::sanitizeForSerialization($comments_post_request));
                }
            } else {
                $httpBody = $comments_post_request;
            }
    ...
    /**
     * Operation commentsPut
     *
     * Edit comment
     *
     * @param  \RecruitisApi\Model\CommentsPutRequest $comments_put_request comments_put_request (optional)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['commentsPut'] to see the possible values for this operation
     *
     * @throws \RecruitisApi\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return mixed[]|int|object|null|\RecruitisApi\Model\CommentsPut200Response|\RecruitisApi\Model\LoginPut401Response
     */
    public function commentsPut($comments_put_request = null, string $contentType = self::contentTypes['commentsPut'][0])
    {
        list($response) = $this->commentsPutWithHttpInfo($comments_put_request, $contentType);
        return $response;
    }

    /**
     * Operation commentsPutWithHttpInfo
     *
     * Edit comment
     *
     * @param  \RecruitisApi\Model\CommentsPutRequest $comments_put_request (optional)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['commentsPut'] to see the possible values for this operation
     *
     * @throws \RecruitisApi\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array<mixed[]|int|object|null|\RecruitisApi\Model\CommentsPut200Response|\RecruitisApi\Model\LoginPut401Response> array of \RecruitisApi\Model\CommentsPut200Response|\RecruitisApi\Model\LoginPut401Response, HTTP status code, HTTP response headers (array of strings)
     */
    public function commentsPutWithHttpInfo($comments_put_request = null, string $contentType = self::contentTypes['commentsPut'][0])
    {
        $request = $this->commentsPutRequest($comments_put_request, $contentType);
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\RecruitisApi\Model\CommentsPut200Response' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\RecruitisApi\Model\CommentsPut200Response' !== 'string') {
                            try {
                                if(defined('JSON_THROW_ON_ERROR')){
                                    $content = json_decode($content, false, 512, JSON_THROW_ON_ERROR);
                                } else {
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\RecruitisApi\Model\CommentsPut200Response', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                case 401:
            ...
            $returnType = '\RecruitisApi\Model\CommentsPut200Response';
            if ($returnType === '\SplFileObject') {
                $content = $response->getBody(); //stream goes to serializer
            } else {
                $content = (string) $response->getBody();
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\RecruitisApi\Model\CommentsPut200Response',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function commentsPutAsync($comments_put_request = null, string $contentType = self::contentTypes['commentsPut'][0])
    {
        return $this->commentsPutAsyncWithHttpInfo($comments_put_request, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation commentsPutAsyncWithHttpInfo
     *
     * Edit comment
     *
     * @param  \RecruitisApi\Model\CommentsPutRequest $comments_put_request (optional)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function commentsPutAsyncWithHttpInfo($comments_put_request = null, string $contentType = self::contentTypes['commentsPut'][0])
    {
        $returnType = '\RecruitisApi\Model\CommentsPut200Response';
        $request = $this->commentsPutRequest($comments_put_request, $contentType);
    ...
    /**
     * Create request for operation 'commentsPut'
     *
     * @param  \RecruitisApi\Model\CommentsPutRequest $comments_put_request (optional)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['commentsPut'] to see the possible values for this operation
     *
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function commentsPutRequest($comments_put_request = null, string $contentType = self::contentTypes['commentsPut'][0])
    {
        ...
        // for model (json/xml)
        if (isset($comments_put_request)) {
            if (stripos($headers['Content-Type'], 'application/json') !== false) {
                # if Content-Type contains "application/json", json_encode the body
                if(PHP_VERSION_ID < 70200){
                    $httpBody = \GuzzleHttp\json_encode(ObjectSerializer::sanitizeForSerialization($comments_put_request));
                } else {
                    $httpBody = \GuzzleHttp\Utils::jsonEncode(ObjectSerializer::sanitizeForSerialization($comments_put_request));
                }
            } else {
                $httpBody = $comments_put_request;
            }
        } elseif (count($formParams) > 0) {
            if ($multipart) {
                $multipartContents = [];
