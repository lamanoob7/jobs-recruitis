...
class CalendarApi
{
     ...
     * @return mixed[]|int|object|null|\RecruitisApi\Model\CalendarInterviewsAnswerIdGet200Response|\RecruitisApi\Model\JobsIdGet404Response
     */
     ...
     * @throws \RecruitisApi\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array<mixed[]|int|object|null|\RecruitisApi\Model\CalendarInterviewsAnswerIdGet200Response|\RecruitisApi\Model\JobsIdGet404Response> array of \RecruitisApi\Model\CalendarInterviewsAnswerIdGet200Response|\RecruitisApi\Model\JobsIdGet404Response, HTTP status code, HTTP response headers (array of strings)
     */
    public function calendarInterviewsAnswerIdGetWithHttpInfo($answer_id, string $contentType = self::contentTypes['calendarInterviewsAnswerIdGet'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\RecruitisApi\Model\CalendarInterviewsAnswerIdGet200Response' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\RecruitisApi\Model\CalendarInterviewsAnswerIdGet200Response' !== 'string') {
                            try {
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\RecruitisApi\Model\CalendarInterviewsAnswerIdGet200Response', []),
            ...
            $returnType = '\RecruitisApi\Model\CalendarInterviewsAnswerIdGet200Response';
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\RecruitisApi\Model\CalendarInterviewsAnswerIdGet200Response',
     ...
     * @throws \RecruitisApi\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return mixed[]|int|object|null|\RecruitisApi\Model\CalendarReservationLinksGet200Response|\RecruitisApi\Model\JobsIdGet404Response
     */
     ...
     * @throws \RecruitisApi\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array<mixed[]|int|object|null|\RecruitisApi\Model\CalendarReservationLinksGet200Response|\RecruitisApi\Model\JobsIdGet404Response> array of \RecruitisApi\Model\CalendarReservationLinksGet200Response|\RecruitisApi\Model\JobsIdGet404Response, HTTP status code, HTTP response headers (array of strings)
     */
    public function calendarReservationLinksGetWithHttpInfo(string $contentType = self::contentTypes['calendarReservationLinksGet'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\RecruitisApi\Model\CalendarReservationLinksGet200Response' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\RecruitisApi\Model\CalendarReservationLinksGet200Response' !== 'string') {
                            try {
                                if(defined('JSON_THROW_ON_ERROR')){
                                    $content = json_decode($content, false, 512, JSON_THROW_ON_ERROR);
                                } else {
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\RecruitisApi\Model\CalendarReservationLinksGet200Response', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                case 404:
            ...
            $returnType = '\RecruitisApi\Model\CalendarReservationLinksGet200Response';
            if ($returnType === '\SplFileObject') {
                $content = $response->getBody(); //stream goes to serializer
            } else {
                $content = (string) $response->getBody();
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\RecruitisApi\Model\CalendarReservationLinksGet200Response',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     * @throws \RecruitisApi\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return mixed[]|int|object|null|\RecruitisApi\Model\CalendarReservationLinksIdDelete200Response|\RecruitisApi\Model\CalendarReservationLinksIdDelete409Response
     */
     ...
     * @throws \RecruitisApi\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array<mixed[]|int|object|null|\RecruitisApi\Model\CalendarReservationLinksIdDelete200Response|\RecruitisApi\Model\CalendarReservationLinksIdDelete409Response> array of \RecruitisApi\Model\CalendarReservationLinksIdDelete200Response|\RecruitisApi\Model\CalendarReservationLinksIdDelete409Response, HTTP status code, HTTP response headers (array of strings)
     */
    public function calendarReservationLinksIdDeleteWithHttpInfo($id, string $contentType = self::contentTypes['calendarReservationLinksIdDelete'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\RecruitisApi\Model\CalendarReservationLinksIdDelete200Response' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\RecruitisApi\Model\CalendarReservationLinksIdDelete200Response' !== 'string') {
                            try {
                                if(defined('JSON_THROW_ON_ERROR')){
                                    $content = json_decode($content, false, 512, JSON_THROW_ON_ERROR);
                                } else {
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\RecruitisApi\Model\CalendarReservationLinksIdDelete200Response', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                case 409:
                    if ('\RecruitisApi\Model\CalendarReservationLinksIdDelete409Response' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\RecruitisApi\Model\CalendarReservationLinksIdDelete409Response' !== 'string') {
                            try {
                                if(defined('JSON_THROW_ON_ERROR')){
                                    $content = json_decode($content, false, 512, JSON_THROW_ON_ERROR);
                                } else {
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\RecruitisApi\Model\CalendarReservationLinksIdDelete409Response', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            }

            $returnType = '\RecruitisApi\Model\CalendarReservationLinksIdDelete200Response';
            if ($returnType === '\SplFileObject') {
                $content = $response->getBody(); //stream goes to serializer
            } else {
                $content = (string) $response->getBody();
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\RecruitisApi\Model\CalendarReservationLinksIdDelete200Response',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
                case 409:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\RecruitisApi\Model\CalendarReservationLinksIdDelete409Response',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     *
     * @param  \RecruitisApi\Model\CalendarReservationLinksPostRequest $calendar_reservation_links_post_request calendar_reservation_links_post_request (optional)
     ...
     * @throws \RecruitisApi\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return mixed[]|int|object|null|\RecruitisApi\Model\CalendarReservationLinksPost201Response|\RecruitisApi\Model\JobsPost400Response
     */
     ...
     * Share reservation link to candidate
     *
     * @param  \RecruitisApi\Model\CalendarReservationLinksPostRequest $calendar_reservation_links_post_request (optional)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['calendarReservationLinksPost'] to see the possible values for this operation
     *
     * @throws \RecruitisApi\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array<mixed[]|int|object|null|\RecruitisApi\Model\CalendarReservationLinksPost201Response|\RecruitisApi\Model\JobsPost400Response> array of \RecruitisApi\Model\CalendarReservationLinksPost201Response|\RecruitisApi\Model\JobsPost400Response, HTTP status code, HTTP response headers (array of strings)
     */
    public function calendarReservationLinksPostWithHttpInfo($calendar_reservation_links_post_request = null, string $contentType = self::contentTypes['calendarReservationLinksPost'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 201:
                    if ('\RecruitisApi\Model\CalendarReservationLinksPost201Response' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\RecruitisApi\Model\CalendarReservationLinksPost201Response' !== 'string') {
                            try {
                                if(defined('JSON_THROW_ON_ERROR')){
                                    $content = json_decode($content, false, 512, JSON_THROW_ON_ERROR);
                                } else {
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\RecruitisApi\Model\CalendarReservationLinksPost201Response', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                case 400:
            ...
            $returnType = '\RecruitisApi\Model\CalendarReservationLinksPost201Response';
            if ($returnType === '\SplFileObject') {
                $content = $response->getBody(); //stream goes to serializer
            } else {
                $content = (string) $response->getBody();
            ...
            switch ($e->getCode()) {
                case 201:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\RecruitisApi\Model\CalendarReservationLinksPost201Response',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
        ...
        if (isset($calendar_reservation_links_post_request)) {
            if (stripos($headers['Content-Type'], 'application/json') !== false) {
                ...
                if(PHP_VERSION_ID < 70200){
                    $httpBody = \GuzzleHttp\json_encode(ObjectSerializer::sanitizeForSerialization($calendar_reservation_links_post_request));
                } else {
