...
class ReferralsApi
{
     ...
     * @return mixed[]|int|object|null|\RecruitisApi\Model\ReferralsGet200Response|\RecruitisApi\Model\LoginPut401Response
     */
     ...
     * @throws \RecruitisApi\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array<mixed[]|int|object|null|\RecruitisApi\Model\ReferralsGet200Response|\RecruitisApi\Model\LoginPut401Response> array of \RecruitisApi\Model\ReferralsGet200Response|\RecruitisApi\Model\LoginPut401Response, HTTP status code, HTTP response headers (array of strings)
     */
    public function referralsGetWithHttpInfo($id = null, $limit = 10, $page = 1, $search = null, string $contentType = self::contentTypes['referralsGet'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\RecruitisApi\Model\ReferralsGet200Response' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\RecruitisApi\Model\ReferralsGet200Response' !== 'string') {
                            try {
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\RecruitisApi\Model\ReferralsGet200Response', []),
            ...
            $returnType = '\RecruitisApi\Model\ReferralsGet200Response';
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\RecruitisApi\Model\ReferralsGet200Response',
     ...
     * @throws \RecruitisApi\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return mixed[]|int|object|null|\RecruitisApi\Model\ReferralsIdGet200Response|\RecruitisApi\Model\JobsIdGet404Response
     */
     ...
     * @throws \RecruitisApi\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array<mixed[]|int|object|null|\RecruitisApi\Model\ReferralsIdGet200Response|\RecruitisApi\Model\JobsIdGet404Response> array of \RecruitisApi\Model\ReferralsIdGet200Response|\RecruitisApi\Model\JobsIdGet404Response, HTTP status code, HTTP response headers (array of strings)
     */
    public function referralsIdGetWithHttpInfo($id, string $contentType = self::contentTypes['referralsIdGet'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\RecruitisApi\Model\ReferralsIdGet200Response' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\RecruitisApi\Model\ReferralsIdGet200Response' !== 'string') {
                            try {
                                if(defined('JSON_THROW_ON_ERROR')){
                                    $content = json_decode($content, false, 512, JSON_THROW_ON_ERROR);
                                } else {
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\RecruitisApi\Model\ReferralsIdGet200Response', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                case 404:
            ...
            $returnType = '\RecruitisApi\Model\ReferralsIdGet200Response';
            if ($returnType === '\SplFileObject') {
                $content = $response->getBody(); //stream goes to serializer
            } else {
                $content = (string) $response->getBody();
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\RecruitisApi\Model\ReferralsIdGet200Response',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     * Create new referal
     *
     * @param  \RecruitisApi\Model\ReferralsPostRequest $referrals_post_request referrals_post_request (optional)
     ...
     * @throws \RecruitisApi\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return mixed[]|int|object|null|\RecruitisApi\Model\ReferralsPost201Response|\RecruitisApi\Model\ReferralsPost409Response
     */
     ...
     * Create new referal
     *
     * @param  \RecruitisApi\Model\ReferralsPostRequest $referrals_post_request (optional)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['referralsPost'] to see the possible values for this operation
     *
     * @throws \RecruitisApi\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array<mixed[]|int|object|null|\RecruitisApi\Model\ReferralsPost201Response|\RecruitisApi\Model\ReferralsPost409Response> array of \RecruitisApi\Model\ReferralsPost201Response|\RecruitisApi\Model\ReferralsPost409Response, HTTP status code, HTTP response headers (array of strings)
     */
    public function referralsPostWithHttpInfo($referrals_post_request = null, string $contentType = self::contentTypes['referralsPost'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 201:
                    if ('\RecruitisApi\Model\ReferralsPost201Response' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\RecruitisApi\Model\ReferralsPost201Response' !== 'string') {
                            try {
                                if(defined('JSON_THROW_ON_ERROR')){
                                    $content = json_decode($content, false, 512, JSON_THROW_ON_ERROR);
                                } else {
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\RecruitisApi\Model\ReferralsPost201Response', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                case 409:
                    if ('\RecruitisApi\Model\ReferralsPost409Response' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\RecruitisApi\Model\ReferralsPost409Response' !== 'string') {
                            try {
                                if(defined('JSON_THROW_ON_ERROR')){
                                    $content = json_decode($content, false, 512, JSON_THROW_ON_ERROR);
                                } else {
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\RecruitisApi\Model\ReferralsPost409Response', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            }

            $returnType = '\RecruitisApi\Model\ReferralsPost201Response';
            if ($returnType === '\SplFileObject') {
                $content = $response->getBody(); //stream goes to serializer
            } else {
                $content = (string) $response->getBody();
            ...
            switch ($e->getCode()) {
                case 201:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\RecruitisApi\Model\ReferralsPost201Response',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
                case 409:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\RecruitisApi\Model\ReferralsPost409Response',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
        ...
        if (isset($referrals_post_request)) {
            if (stripos($headers['Content-Type'], 'application/json') !== false) {
                ...
                if(PHP_VERSION_ID < 70200){
                    $httpBody = \GuzzleHttp\json_encode(ObjectSerializer::sanitizeForSerialization($referrals_post_request));
                } else {
