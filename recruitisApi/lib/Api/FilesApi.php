...
class FilesApi
{
     ...
     * @return mixed[]|int|object|null|\RecruitisApi\Model\FilesHashGet200Response|\RecruitisApi\Model\JobsIdGet404Response|\RecruitisApi\Model\FilesHashGet413Response
     */
     ...
     * @throws \RecruitisApi\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array<mixed[]|int|object|null|\RecruitisApi\Model\FilesHashGet200Response|\RecruitisApi\Model\JobsIdGet404Response|\RecruitisApi\Model\FilesHashGet413Response> array of \RecruitisApi\Model\FilesHashGet200Response|\RecruitisApi\Model\JobsIdGet404Response|\RecruitisApi\Model\FilesHashGet413Response, HTTP status code, HTTP response headers (array of strings)
     */
    public function filesHashGetWithHttpInfo($hash, string $contentType = self::contentTypes['filesHashGet'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\RecruitisApi\Model\FilesHashGet200Response' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\RecruitisApi\Model\FilesHashGet200Response' !== 'string') {
                            try {
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\RecruitisApi\Model\FilesHashGet200Response', []),
                ...
                case 413:
                    if ('\RecruitisApi\Model\FilesHashGet413Response' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\RecruitisApi\Model\FilesHashGet413Response' !== 'string') {
                            try {
                                if(defined('JSON_THROW_ON_ERROR')){
                                    $content = json_decode($content, false, 512, JSON_THROW_ON_ERROR);
                                } else {
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\RecruitisApi\Model\FilesHashGet413Response', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            }

            $returnType = '\RecruitisApi\Model\FilesHashGet200Response';
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\RecruitisApi\Model\FilesHashGet200Response',
                ...
                case 413:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\RecruitisApi\Model\FilesHashGet413Response',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
