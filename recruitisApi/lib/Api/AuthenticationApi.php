...
class AuthenticationApi
{
     ...
     * Log in
     *
     * @param  \RecruitisApi\Model\LoginPutRequest $login_put_request login_put_request (optional)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['loginPut'] to see the possible values for this operation
     *
     * @throws \RecruitisApi\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return mixed[]|int|object|null|\RecruitisApi\Model\LoginPut200Response|\RecruitisApi\Model\LoginPut401Response
     */
    public function loginPut($login_put_request = null, string $contentType = self::contentTypes['loginPut'][0])
    {
        list($response) = $this->loginPutWithHttpInfo($login_put_request, $contentType);
        return $response;
    }

    /**
     * Operation loginPutWithHttpInfo
     *
     * Log in
     *
     * @param  \RecruitisApi\Model\LoginPutRequest $login_put_request (optional)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['loginPut'] to see the possible values for this operation
     *
     * @throws \RecruitisApi\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array<mixed[]|int|object|null|\RecruitisApi\Model\LoginPut200Response|\RecruitisApi\Model\LoginPut401Response> array of \RecruitisApi\Model\LoginPut200Response|\RecruitisApi\Model\LoginPut401Response, HTTP status code, HTTP response headers (array of strings)
     */
    public function loginPutWithHttpInfo($login_put_request = null, string $contentType = self::contentTypes['loginPut'][0])
    {
        $request = $this->loginPutRequest($login_put_request, $contentType);
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\RecruitisApi\Model\LoginPut200Response' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\RecruitisApi\Model\LoginPut200Response' !== 'string') {
                            try {
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\RecruitisApi\Model\LoginPut200Response', []),
            ...
            $returnType = '\RecruitisApi\Model\LoginPut200Response';
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\RecruitisApi\Model\LoginPut200Response',
     ...
     */
    public function loginPutAsync($login_put_request = null, string $contentType = self::contentTypes['loginPut'][0])
    {
        return $this->loginPutAsyncWithHttpInfo($login_put_request, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation loginPutAsyncWithHttpInfo
     *
     * Log in
     *
     * @param  \RecruitisApi\Model\LoginPutRequest $login_put_request (optional)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function loginPutAsyncWithHttpInfo($login_put_request = null, string $contentType = self::contentTypes['loginPut'][0])
    {
        $returnType = '\RecruitisApi\Model\LoginPut200Response';
        $request = $this->loginPutRequest($login_put_request, $contentType);
    ...
    /**
     * Create request for operation 'loginPut'
     *
     * @param  \RecruitisApi\Model\LoginPutRequest $login_put_request (optional)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['loginPut'] to see the possible values for this operation
     *
     ...
     */
    public function loginPutRequest($login_put_request = null, string $contentType = self::contentTypes['loginPut'][0])
    {
        ...
        // for model (json/xml)
        if (isset($login_put_request)) {
            if (stripos($headers['Content-Type'], 'application/json') !== false) {
                # if Content-Type contains "application/json", json_encode the body
                if(PHP_VERSION_ID < 70200){
                    $httpBody = \GuzzleHttp\json_encode(ObjectSerializer::sanitizeForSerialization($login_put_request));
                } else {
                    $httpBody = \GuzzleHttp\Utils::jsonEncode(ObjectSerializer::sanitizeForSerialization($login_put_request));
                }
            } else {
                $httpBody = $login_put_request;
            }
     ...
     * Log out
     *
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['logoutPut'] to see the possible values for this operation
     *
     * @throws \RecruitisApi\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return mixed[]|int|object|null|\RecruitisApi\Model\LogoutPut200Response|\RecruitisApi\Model\LoginPut401Response
     */
    public function logoutPut(string $contentType = self::contentTypes['logoutPut'][0])
    {
        list($response) = $this->logoutPutWithHttpInfo($contentType);
        return $response;
    }

    /**
     * Operation logoutPutWithHttpInfo
     *
     * Log out
     *
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['logoutPut'] to see the possible values for this operation
     ...
     * @throws \RecruitisApi\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array<mixed[]|int|object|null|\RecruitisApi\Model\LogoutPut200Response|\RecruitisApi\Model\LoginPut401Response> array of \RecruitisApi\Model\LogoutPut200Response|\RecruitisApi\Model\LoginPut401Response, HTTP status code, HTTP response headers (array of strings)
     */
    public function logoutPutWithHttpInfo(string $contentType = self::contentTypes['logoutPut'][0])
    {
        $request = $this->logoutPutRequest($contentType);
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\RecruitisApi\Model\LogoutPut200Response' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\RecruitisApi\Model\LogoutPut200Response' !== 'string') {
                            try {
                                if(defined('JSON_THROW_ON_ERROR')){
                                    $content = json_decode($content, false, 512, JSON_THROW_ON_ERROR);
                                } else {
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\RecruitisApi\Model\LogoutPut200Response', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                case 401:
            ...
            $returnType = '\RecruitisApi\Model\LogoutPut200Response';
            if ($returnType === '\SplFileObject') {
                $content = $response->getBody(); //stream goes to serializer
            } else {
                $content = (string) $response->getBody();
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\RecruitisApi\Model\LogoutPut200Response',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function logoutPutAsync(string $contentType = self::contentTypes['logoutPut'][0])
    {
        return $this->logoutPutAsyncWithHttpInfo($contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation logoutPutAsyncWithHttpInfo
     *
     * Log out
     *
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['logoutPut'] to see the possible values for this operation
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function logoutPutAsyncWithHttpInfo(string $contentType = self::contentTypes['logoutPut'][0])
    {
        $returnType = '\RecruitisApi\Model\LogoutPut200Response';
        $request = $this->logoutPutRequest($contentType);
    ...
    /**
     * Create request for operation 'logoutPut'
     *
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['logoutPut'] to see the possible values for this operation
     *
     * @throws \InvalidArgumentException
     * @return \GuzzleHttp\Psr7\Request
     */
    public function logoutPutRequest(string $contentType = self::contentTypes['logoutPut'][0])
    {
