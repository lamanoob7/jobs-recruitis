...
/**
 * JobFiltersApi Class Doc Comment
 *
 * @category Class
 * @package  RecruitisApi
 * @author   OpenAPI Generator team
...
class JobFiltersApi
{
     ...
     * Get filters
     *
     * @param  string[] $group Vyfiltruje pouze seznam filtrů k dané skupině. (optional)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['filtersGet'] to see the possible values for this operation
     *
     * @throws \RecruitisApi\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return mixed[]|int|object|null|\RecruitisApi\Model\FiltersGet200Response|\RecruitisApi\Model\LoginPut401Response
     */
    public function filtersGet($group = null, string $contentType = self::contentTypes['filtersGet'][0])
    {
        list($response) = $this->filtersGetWithHttpInfo($group, $contentType);
        return $response;
    }

    /**
     * Operation filtersGetWithHttpInfo
     *
     * Get filters
     *
     * @param  string[] $group Vyfiltruje pouze seznam filtrů k dané skupině. (optional)
     ...
     * @throws \RecruitisApi\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array<mixed[]|int|object|null|\RecruitisApi\Model\FiltersGet200Response|\RecruitisApi\Model\LoginPut401Response> array of \RecruitisApi\Model\FiltersGet200Response|\RecruitisApi\Model\LoginPut401Response, HTTP status code, HTTP response headers (array of strings)
     */
    public function filtersGetWithHttpInfo($group = null, string $contentType = self::contentTypes['filtersGet'][0])
    {
        $request = $this->filtersGetRequest($group, $contentType);
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\RecruitisApi\Model\FiltersGet200Response' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\RecruitisApi\Model\FiltersGet200Response' !== 'string') {
                            try {
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\RecruitisApi\Model\FiltersGet200Response', []),
            ...
            $returnType = '\RecruitisApi\Model\FiltersGet200Response';
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\RecruitisApi\Model\FiltersGet200Response',
     ...
     */
    public function filtersGetAsync($group = null, string $contentType = self::contentTypes['filtersGet'][0])
    {
        return $this->filtersGetAsyncWithHttpInfo($group, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation filtersGetAsyncWithHttpInfo
     *
     * Get filters
     *
     * @param  string[] $group Vyfiltruje pouze seznam filtrů k dané skupině. (optional)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function filtersGetAsyncWithHttpInfo($group = null, string $contentType = self::contentTypes['filtersGet'][0])
    {
        $returnType = '\RecruitisApi\Model\FiltersGet200Response';
        $request = $this->filtersGetRequest($group, $contentType);
    ...
    /**
     * Create request for operation 'filtersGet'
     *
     * @param  string[] $group Vyfiltruje pouze seznam filtrů k dané skupině. (optional)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['filtersGet'] to see the possible values for this operation
     *
     ...
     */
    public function filtersGetRequest($group = null, string $contentType = self::contentTypes['filtersGet'][0])
    {
    ...
    /**
     * Operation filtersIdDelete
     *
     * Delete existing filter
     *
     * @param  int $id id (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['filtersIdDelete'] to see the possible values for this operation
     *
     * @throws \RecruitisApi\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return mixed[]|int|object|null|\RecruitisApi\Model\FiltersIdDelete200Response|\RecruitisApi\Model\LoginPut401Response
     */
    public function filtersIdDelete($id, string $contentType = self::contentTypes['filtersIdDelete'][0])
    {
        list($response) = $this->filtersIdDeleteWithHttpInfo($id, $contentType);
        return $response;
    }

    /**
     * Operation filtersIdDeleteWithHttpInfo
     *
     * Delete existing filter
     *
     ...
     * @throws \RecruitisApi\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array<mixed[]|int|object|null|\RecruitisApi\Model\FiltersIdDelete200Response|\RecruitisApi\Model\LoginPut401Response> array of \RecruitisApi\Model\FiltersIdDelete200Response|\RecruitisApi\Model\LoginPut401Response, HTTP status code, HTTP response headers (array of strings)
     */
    public function filtersIdDeleteWithHttpInfo($id, string $contentType = self::contentTypes['filtersIdDelete'][0])
    {
        $request = $this->filtersIdDeleteRequest($id, $contentType);
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\RecruitisApi\Model\FiltersIdDelete200Response' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\RecruitisApi\Model\FiltersIdDelete200Response' !== 'string') {
                            try {
                                if(defined('JSON_THROW_ON_ERROR')){
                                    $content = json_decode($content, false, 512, JSON_THROW_ON_ERROR);
                                } else {
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\RecruitisApi\Model\FiltersIdDelete200Response', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                case 401:
            ...
            $returnType = '\RecruitisApi\Model\FiltersIdDelete200Response';
            if ($returnType === '\SplFileObject') {
                $content = $response->getBody(); //stream goes to serializer
            } else {
                $content = (string) $response->getBody();
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\RecruitisApi\Model\FiltersIdDelete200Response',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
    ...
    /**
     * Operation filtersIdDeleteAsync
     *
     * Delete existing filter
     *
     * @param  int $id (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function filtersIdDeleteAsync($id, string $contentType = self::contentTypes['filtersIdDelete'][0])
    {
        return $this->filtersIdDeleteAsyncWithHttpInfo($id, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation filtersIdDeleteAsyncWithHttpInfo
     *
     * Delete existing filter
     *
     * @param  int $id (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function filtersIdDeleteAsyncWithHttpInfo($id, string $contentType = self::contentTypes['filtersIdDelete'][0])
    {
        $returnType = '\RecruitisApi\Model\FiltersIdDelete200Response';
        $request = $this->filtersIdDeleteRequest($id, $contentType);
    ...
    /**
     * Create request for operation 'filtersIdDelete'
     *
     * @param  int $id (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['filtersIdDelete'] to see the possible values for this operation
     *
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function filtersIdDeleteRequest($id, string $contentType = self::contentTypes['filtersIdDelete'][0])
    {

        // verify the required parameter 'id' is set
        if ($id === null || (is_array($id) && count($id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $id when calling filtersIdDelete'
            );
        }
    ...
    /**
     * Operation filtersIdPut
     *
     * Update existing filter
     *
     * @param  int $id id (required)
     * @param  \RecruitisApi\Model\FiltersPostRequest $filters_post_request filters_post_request (optional)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['filtersIdPut'] to see the possible values for this operation
     *
     * @throws \RecruitisApi\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return mixed[]|int|object|null|\RecruitisApi\Model\FiltersIdPut201Response|\RecruitisApi\Model\LoginPut401Response
     */
    public function filtersIdPut($id, $filters_post_request = null, string $contentType = self::contentTypes['filtersIdPut'][0])
    {
        list($response) = $this->filtersIdPutWithHttpInfo($id, $filters_post_request, $contentType);
        return $response;
    }

    /**
     * Operation filtersIdPutWithHttpInfo
     *
     * Update existing filter
     *
     * @param  int $id (required)
     * @param  \RecruitisApi\Model\FiltersPostRequest $filters_post_request (optional)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['filtersIdPut'] to see the possible values for this operation
     *
     * @throws \RecruitisApi\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array<mixed[]|int|object|null|\RecruitisApi\Model\FiltersIdPut201Response|\RecruitisApi\Model\LoginPut401Response> array of \RecruitisApi\Model\FiltersIdPut201Response|\RecruitisApi\Model\LoginPut401Response, HTTP status code, HTTP response headers (array of strings)
     */
    public function filtersIdPutWithHttpInfo($id, $filters_post_request = null, string $contentType = self::contentTypes['filtersIdPut'][0])
    {
        $request = $this->filtersIdPutRequest($id, $filters_post_request, $contentType);
        ...
        try {
            ...
            switch($statusCode) {
                case 201:
                    if ('\RecruitisApi\Model\FiltersIdPut201Response' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\RecruitisApi\Model\FiltersIdPut201Response' !== 'string') {
                            try {
                                if(defined('JSON_THROW_ON_ERROR')){
                                    $content = json_decode($content, false, 512, JSON_THROW_ON_ERROR);
                                } else {
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\RecruitisApi\Model\FiltersIdPut201Response', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                case 401:
            ...
            $returnType = '\RecruitisApi\Model\FiltersIdPut201Response';
            if ($returnType === '\SplFileObject') {
                $content = $response->getBody(); //stream goes to serializer
            } else {
                $content = (string) $response->getBody();
            ...
            switch ($e->getCode()) {
                case 201:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\RecruitisApi\Model\FiltersIdPut201Response',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function filtersIdPutAsync($id, $filters_post_request = null, string $contentType = self::contentTypes['filtersIdPut'][0])
    {
        return $this->filtersIdPutAsyncWithHttpInfo($id, $filters_post_request, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation filtersIdPutAsyncWithHttpInfo
     *
     * Update existing filter
     *
     * @param  int $id (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function filtersIdPutAsyncWithHttpInfo($id, $filters_post_request = null, string $contentType = self::contentTypes['filtersIdPut'][0])
    {
        $returnType = '\RecruitisApi\Model\FiltersIdPut201Response';
        $request = $this->filtersIdPutRequest($id, $filters_post_request, $contentType);
    ...
    /**
     * Create request for operation 'filtersIdPut'
     *
     * @param  int $id (required)
     * @param  \RecruitisApi\Model\FiltersPostRequest $filters_post_request (optional)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['filtersIdPut'] to see the possible values for this operation
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function filtersIdPutRequest($id, $filters_post_request = null, string $contentType = self::contentTypes['filtersIdPut'][0])
    {

        // verify the required parameter 'id' is set
        if ($id === null || (is_array($id) && count($id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $id when calling filtersIdPut'
            );
        }
        ...
        // for model (json/xml)
        if (isset($filters_post_request)) {
            if (stripos($headers['Content-Type'], 'application/json') !== false) {
                # if Content-Type contains "application/json", json_encode the body
                if(PHP_VERSION_ID < 70200){
                    $httpBody = \GuzzleHttp\json_encode(ObjectSerializer::sanitizeForSerialization($filters_post_request));
                } else {
                    $httpBody = \GuzzleHttp\Utils::jsonEncode(ObjectSerializer::sanitizeForSerialization($filters_post_request));
                }
            } else {
                $httpBody = $filters_post_request;
            }
    ...
    /**
     * Operation filtersPost
     *
     * Create new filter
     *
     * @param  \RecruitisApi\Model\FiltersPostRequest $filters_post_request filters_post_request (optional)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['filtersPost'] to see the possible values for this operation
     *
     * @throws \RecruitisApi\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return mixed[]|int|object|null|\RecruitisApi\Model\FiltersPost201Response|\RecruitisApi\Model\LoginPut401Response
     */
    public function filtersPost($filters_post_request = null, string $contentType = self::contentTypes['filtersPost'][0])
    {
        list($response) = $this->filtersPostWithHttpInfo($filters_post_request, $contentType);
        return $response;
    }

    /**
     * Operation filtersPostWithHttpInfo
     *
     * Create new filter
     *
     * @param  \RecruitisApi\Model\FiltersPostRequest $filters_post_request (optional)
     ...
     * @throws \RecruitisApi\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array<mixed[]|int|object|null|\RecruitisApi\Model\FiltersPost201Response|\RecruitisApi\Model\LoginPut401Response> array of \RecruitisApi\Model\FiltersPost201Response|\RecruitisApi\Model\LoginPut401Response, HTTP status code, HTTP response headers (array of strings)
     */
    public function filtersPostWithHttpInfo($filters_post_request = null, string $contentType = self::contentTypes['filtersPost'][0])
    {
        $request = $this->filtersPostRequest($filters_post_request, $contentType);
        ...
        try {
            ...
            switch($statusCode) {
                case 201:
                    if ('\RecruitisApi\Model\FiltersPost201Response' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\RecruitisApi\Model\FiltersPost201Response' !== 'string') {
                            try {
                                if(defined('JSON_THROW_ON_ERROR')){
                                    $content = json_decode($content, false, 512, JSON_THROW_ON_ERROR);
                                } else {
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\RecruitisApi\Model\FiltersPost201Response', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                case 401:
            ...
            $returnType = '\RecruitisApi\Model\FiltersPost201Response';
            if ($returnType === '\SplFileObject') {
                $content = $response->getBody(); //stream goes to serializer
            } else {
                $content = (string) $response->getBody();
            ...
            switch ($e->getCode()) {
                case 201:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\RecruitisApi\Model\FiltersPost201Response',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function filtersPostAsync($filters_post_request = null, string $contentType = self::contentTypes['filtersPost'][0])
    {
        return $this->filtersPostAsyncWithHttpInfo($filters_post_request, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation filtersPostAsyncWithHttpInfo
     *
     * Create new filter
     *
     * @param  \RecruitisApi\Model\FiltersPostRequest $filters_post_request (optional)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function filtersPostAsyncWithHttpInfo($filters_post_request = null, string $contentType = self::contentTypes['filtersPost'][0])
    {
        $returnType = '\RecruitisApi\Model\FiltersPost201Response';
        $request = $this->filtersPostRequest($filters_post_request, $contentType);
    ...
    /**
     * Create request for operation 'filtersPost'
     *
     * @param  \RecruitisApi\Model\FiltersPostRequest $filters_post_request (optional)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['filtersPost'] to see the possible values for this operation
     *
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function filtersPostRequest($filters_post_request = null, string $contentType = self::contentTypes['filtersPost'][0])
    {
