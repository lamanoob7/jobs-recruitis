...
class JobsApi
{
     ...
     * @return mixed[]|int|object|null|\RecruitisApi\Model\JobsGet200Response|\RecruitisApi\Model\LoginPut401Response
     */
     ...
     * @throws \RecruitisApi\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array<mixed[]|int|object|null|\RecruitisApi\Model\JobsGet200Response|\RecruitisApi\Model\LoginPut401Response> array of \RecruitisApi\Model\JobsGet200Response|\RecruitisApi\Model\LoginPut401Response, HTTP status code, HTTP response headers (array of strings)
     */
    public function jobsGetWithHttpInfo($limit = 10, $page = 1, $with_automation = null, $text_language = null, $workfield_id = null, $office_id = null, $filter_id = null, $channel_id = null, $order_by = 'date_created', $include_inactive = false, $only_deleted = false, $status = 1, $activity_state = 1, $access_state = null, $with_rewards = null, $updated_from = null, $updated_to = null, string $contentType = self::contentTypes['jobsGet'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\RecruitisApi\Model\JobsGet200Response' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\RecruitisApi\Model\JobsGet200Response' !== 'string') {
                            try {
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\RecruitisApi\Model\JobsGet200Response', []),
            ...
            $returnType = '\RecruitisApi\Model\JobsGet200Response';
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\RecruitisApi\Model\JobsGet200Response',
     ...
     * @param  \RecruitisApi\Model\JobsIdAccessPutRequest $jobs_id_access_put_request jobs_id_access_put_request (optional)
     ...
     * @throws \RecruitisApi\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return mixed[]|int|object|null|\RecruitisApi\Model\JobsIdAccessPut200Response|\RecruitisApi\Model\JobsIdGet404Response
     */
     ...
     * @param  \RecruitisApi\Model\JobsIdAccessPutRequest $jobs_id_access_put_request (optional)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['jobsIdAccessPut'] to see the possible values for this operation
     *
     * @throws \RecruitisApi\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array<mixed[]|int|object|null|\RecruitisApi\Model\JobsIdAccessPut200Response|\RecruitisApi\Model\JobsIdGet404Response> array of \RecruitisApi\Model\JobsIdAccessPut200Response|\RecruitisApi\Model\JobsIdGet404Response, HTTP status code, HTTP response headers (array of strings)
     */
    public function jobsIdAccessPutWithHttpInfo($id, $jobs_id_access_put_request = null, string $contentType = self::contentTypes['jobsIdAccessPut'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\RecruitisApi\Model\JobsIdAccessPut200Response' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\RecruitisApi\Model\JobsIdAccessPut200Response' !== 'string') {
                            try {
                                if(defined('JSON_THROW_ON_ERROR')){
                                    $content = json_decode($content, false, 512, JSON_THROW_ON_ERROR);
                                } else {
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\RecruitisApi\Model\JobsIdAccessPut200Response', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                case 404:
            ...
            $returnType = '\RecruitisApi\Model\JobsIdAccessPut200Response';
            if ($returnType === '\SplFileObject') {
                $content = $response->getBody(); //stream goes to serializer
            } else {
                $content = (string) $response->getBody();
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\RecruitisApi\Model\JobsIdAccessPut200Response',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
        ...
        if (isset($jobs_id_access_put_request)) {
            if (stripos($headers['Content-Type'], 'application/json') !== false) {
                ...
                if(PHP_VERSION_ID < 70200){
                    $httpBody = \GuzzleHttp\json_encode(ObjectSerializer::sanitizeForSerialization($jobs_id_access_put_request));
                } else {
     ...
     * @throws \RecruitisApi\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return mixed[]|int|object|null|\RecruitisApi\Model\JobsIdAccessStateStatePut200Response|\RecruitisApi\Model\JobsIdGet404Response
     */
     ...
     * @throws \RecruitisApi\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array<mixed[]|int|object|null|\RecruitisApi\Model\JobsIdAccessStateStatePut200Response|\RecruitisApi\Model\JobsIdGet404Response> array of \RecruitisApi\Model\JobsIdAccessStateStatePut200Response|\RecruitisApi\Model\JobsIdGet404Response, HTTP status code, HTTP response headers (array of strings)
     */
    public function jobsIdAccessStateStatePutWithHttpInfo($id, $state, string $contentType = self::contentTypes['jobsIdAccessStateStatePut'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\RecruitisApi\Model\JobsIdAccessStateStatePut200Response' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\RecruitisApi\Model\JobsIdAccessStateStatePut200Response' !== 'string') {
                            try {
                                if(defined('JSON_THROW_ON_ERROR')){
                                    $content = json_decode($content, false, 512, JSON_THROW_ON_ERROR);
                                } else {
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\RecruitisApi\Model\JobsIdAccessStateStatePut200Response', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                case 404:
            ...
            $returnType = '\RecruitisApi\Model\JobsIdAccessStateStatePut200Response';
            if ($returnType === '\SplFileObject') {
                $content = $response->getBody(); //stream goes to serializer
            } else {
                $content = (string) $response->getBody();
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\RecruitisApi\Model\JobsIdAccessStateStatePut200Response',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     * @throws \RecruitisApi\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return mixed[]|int|object|null|\RecruitisApi\Model\JobsIdChannelChannelIdDelete202Response|\RecruitisApi\Model\JobsPost400Response|\RecruitisApi\Model\JobsIdGet404Response
     */
     ...
     * @throws \RecruitisApi\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array<mixed[]|int|object|null|\RecruitisApi\Model\JobsIdChannelChannelIdDelete202Response|\RecruitisApi\Model\JobsPost400Response|\RecruitisApi\Model\JobsIdGet404Response> array of \RecruitisApi\Model\JobsIdChannelChannelIdDelete202Response|\RecruitisApi\Model\JobsPost400Response|\RecruitisApi\Model\JobsIdGet404Response, HTTP status code, HTTP response headers (array of strings)
     */
    public function jobsIdChannelChannelIdDeleteWithHttpInfo($id, $channel_id, string $contentType = self::contentTypes['jobsIdChannelChannelIdDelete'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 202:
                    if ('\RecruitisApi\Model\JobsIdChannelChannelIdDelete202Response' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\RecruitisApi\Model\JobsIdChannelChannelIdDelete202Response' !== 'string') {
                            try {
                                if(defined('JSON_THROW_ON_ERROR')){
                                    $content = json_decode($content, false, 512, JSON_THROW_ON_ERROR);
                                } else {
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\RecruitisApi\Model\JobsIdChannelChannelIdDelete202Response', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                case 400:
            ...
            $returnType = '\RecruitisApi\Model\JobsIdChannelChannelIdDelete202Response';
            if ($returnType === '\SplFileObject') {
                $content = $response->getBody(); //stream goes to serializer
            } else {
                $content = (string) $response->getBody();
            ...
            switch ($e->getCode()) {
                case 202:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\RecruitisApi\Model\JobsIdChannelChannelIdDelete202Response',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     * @param  int $id id (required)
     * @param  JobsIdChannelChannelIdPutChannelIdParameter $channel_id channel_id (required)
     * @param  \RecruitisApi\Model\JobsIdChannelChannelIdPutRequest $jobs_id_channel_channel_id_put_request jobs_id_channel_channel_id_put_request (optional)
     ...
     * @throws \RecruitisApi\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return mixed[]|int|object|null|\RecruitisApi\Model\JobsIdChannelChannelIdPut202Response|\RecruitisApi\Model\JobsPost400Response|\RecruitisApi\Model\JobsIdGet404Response
     */
     ...
     * @param  int $id (required)
     * @param  JobsIdChannelChannelIdPutChannelIdParameter $channel_id (required)
     * @param  \RecruitisApi\Model\JobsIdChannelChannelIdPutRequest $jobs_id_channel_channel_id_put_request (optional)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['jobsIdChannelChannelIdPut'] to see the possible values for this operation
     *
     * @throws \RecruitisApi\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array<mixed[]|int|object|null|\RecruitisApi\Model\JobsIdChannelChannelIdPut202Response|\RecruitisApi\Model\JobsPost400Response|\RecruitisApi\Model\JobsIdGet404Response> array of \RecruitisApi\Model\JobsIdChannelChannelIdPut202Response|\RecruitisApi\Model\JobsPost400Response|\RecruitisApi\Model\JobsIdGet404Response, HTTP status code, HTTP response headers (array of strings)
     */
    public function jobsIdChannelChannelIdPutWithHttpInfo($id, $channel_id, $jobs_id_channel_channel_id_put_request = null, string $contentType = self::contentTypes['jobsIdChannelChannelIdPut'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 202:
                    if ('\RecruitisApi\Model\JobsIdChannelChannelIdPut202Response' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\RecruitisApi\Model\JobsIdChannelChannelIdPut202Response' !== 'string') {
                            try {
                                if(defined('JSON_THROW_ON_ERROR')){
                                    $content = json_decode($content, false, 512, JSON_THROW_ON_ERROR);
                                } else {
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\RecruitisApi\Model\JobsIdChannelChannelIdPut202Response', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                case 400:
            ...
            $returnType = '\RecruitisApi\Model\JobsIdChannelChannelIdPut202Response';
            if ($returnType === '\SplFileObject') {
                $content = $response->getBody(); //stream goes to serializer
            } else {
                $content = (string) $response->getBody();
            ...
            switch ($e->getCode()) {
                case 202:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\RecruitisApi\Model\JobsIdChannelChannelIdPut202Response',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
    ...
    public function jobsIdChannelChannelIdPutRequest($id, $channel_id, $jobs_id_channel_channel_id_put_request = null, string $contentType = self::contentTypes['jobsIdChannelChannelIdPut'][0])
    {
        ...
        if (isset($jobs_id_channel_channel_id_put_request)) {
            if (stripos($headers['Content-Type'], 'application/json') !== false) {
                # if Content-Type contains "application/json", json_encode the body
                if(PHP_VERSION_ID < 70200){
                    $httpBody = \GuzzleHttp\json_encode(ObjectSerializer::sanitizeForSerialization($jobs_id_channel_channel_id_put_request));
                } else {
     ...
     * @throws \RecruitisApi\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return mixed[]|int|object|null|\RecruitisApi\Model\JobsIdChannelsGet200Response|\RecruitisApi\Model\JobsIdGet404Response
     */
     ...
     * @throws \RecruitisApi\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array<mixed[]|int|object|null|\RecruitisApi\Model\JobsIdChannelsGet200Response|\RecruitisApi\Model\JobsIdGet404Response> array of \RecruitisApi\Model\JobsIdChannelsGet200Response|\RecruitisApi\Model\JobsIdGet404Response, HTTP status code, HTTP response headers (array of strings)
     */
    public function jobsIdChannelsGetWithHttpInfo($id, string $contentType = self::contentTypes['jobsIdChannelsGet'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\RecruitisApi\Model\JobsIdChannelsGet200Response' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\RecruitisApi\Model\JobsIdChannelsGet200Response' !== 'string') {
                            try {
                                if(defined('JSON_THROW_ON_ERROR')){
                                    $content = json_decode($content, false, 512, JSON_THROW_ON_ERROR);
                                } else {
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\RecruitisApi\Model\JobsIdChannelsGet200Response', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                case 404:
            ...
            $returnType = '\RecruitisApi\Model\JobsIdChannelsGet200Response';
            if ($returnType === '\SplFileObject') {
                $content = $response->getBody(); //stream goes to serializer
            } else {
                $content = (string) $response->getBody();
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\RecruitisApi\Model\JobsIdChannelsGet200Response',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     * @throws \RecruitisApi\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return mixed[]|int|object|null|\RecruitisApi\Model\JobsIdFormGet200Response|\RecruitisApi\Model\JobsIdGet404Response
     */
     ...
     * @throws \RecruitisApi\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array<mixed[]|int|object|null|\RecruitisApi\Model\JobsIdFormGet200Response|\RecruitisApi\Model\JobsIdGet404Response|> array of \RecruitisApi\Model\JobsIdFormGet200Response|\RecruitisApi\Model\JobsIdGet404Response, HTTP status code, HTTP response headers (array of strings)
     */
    public function jobsIdFormGetWithHttpInfo($id, string $contentType = self::contentTypes['jobsIdFormGet'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\RecruitisApi\Model\JobsIdFormGet200Response' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\RecruitisApi\Model\JobsIdFormGet200Response' !== 'string') {
                            try {
                                if(defined('JSON_THROW_ON_ERROR')){
                                    $content = json_decode($content, false, 512, JSON_THROW_ON_ERROR);
                                } else {
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\RecruitisApi\Model\JobsIdFormGet200Response', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                case 404:
            ...
            $returnType = '\RecruitisApi\Model\JobsIdFormGet200Response';
            if ($returnType === '\SplFileObject') {
                $content = $response->getBody(); //stream goes to serializer
            } else {
                $content = (string) $response->getBody();
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\RecruitisApi\Model\JobsIdFormGet200Response',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     * @param  \RecruitisApi\Model\JobsIdFormValidatePostRequest $jobs_id_form_validate_post_request Hodnoty z odpovědního formuláře ve formátu pole &#x3D;&gt; hodnota. Jelikož se jedná o JSON API, nikoliv multipart form, je potřeba poslat přílohy (CV) jako pole objektů dle schematu. (optional)
     ...
     * @throws \RecruitisApi\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return mixed[]|int|object|null|\RecruitisApi\Model\JobsIdFormValidatePost200Response|\RecruitisApi\Model\JobsIdFormValidatePost400Response|\RecruitisApi\Model\JobsIdFormValidatePost404Response|\RecruitisApi\Model\JobsIdFormValidatePost404Response
     */
     ...
     * @throws \RecruitisApi\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array<mixed[]|int|object|null|\RecruitisApi\Model\JobsIdFormValidatePost200Response|\RecruitisApi\Model\JobsIdFormValidatePost400Response|\RecruitisApi\Model\JobsIdFormValidatePost404Response|\RecruitisApi\Model\JobsIdFormValidatePost404Response> array of \RecruitisApi\Model\JobsIdFormValidatePost200Response|\RecruitisApi\Model\JobsIdFormValidatePost400Response|\RecruitisApi\Model\JobsIdFormValidatePost404Response|\RecruitisApi\Model\JobsIdFormValidatePost404Response, HTTP status code, HTTP response headers (array of strings)
     */
    public function jobsIdFormValidatePostWithHttpInfo($id, $accept_language = null, $jobs_id_form_validate_post_request = null, string $contentType = self::contentTypes['jobsIdFormValidatePost'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\RecruitisApi\Model\JobsIdFormValidatePost200Response' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\RecruitisApi\Model\JobsIdFormValidatePost200Response' !== 'string') {
                            try {
                                if(defined('JSON_THROW_ON_ERROR')){
                                    $content = json_decode($content, false, 512, JSON_THROW_ON_ERROR);
                                } else {
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\RecruitisApi\Model\JobsIdFormValidatePost200Response', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                case 400:
                    if ('\RecruitisApi\Model\JobsIdFormValidatePost400Response' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\RecruitisApi\Model\JobsIdFormValidatePost400Response' !== 'string') {
                            try {
                                if(defined('JSON_THROW_ON_ERROR')){
                                    $content = json_decode($content, false, 512, JSON_THROW_ON_ERROR);
                                } else {
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\RecruitisApi\Model\JobsIdFormValidatePost400Response', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                case 404:
                    if ('\RecruitisApi\Model\JobsIdFormValidatePost404Response' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\RecruitisApi\Model\JobsIdFormValidatePost404Response' !== 'string') {
                            try {
                                if(defined('JSON_THROW_ON_ERROR')){
                                    $content = json_decode($content, false, 512, JSON_THROW_ON_ERROR);
                                } else {
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\RecruitisApi\Model\JobsIdFormValidatePost404Response', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                case 500:
            ...
            $returnType = '\RecruitisApi\Model\JobsIdFormValidatePost200Response';
            if ($returnType === '\SplFileObject') {
                $content = $response->getBody(); //stream goes to serializer
            } else {
                $content = (string) $response->getBody();
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\RecruitisApi\Model\JobsIdFormValidatePost200Response',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
                case 400:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\RecruitisApi\Model\JobsIdFormValidatePost400Response',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
    ...
    public function jobsIdFormValidatePostRequest($id, $accept_language = null, $jobs_id_form_validate_post_request = null, string $contentType = self::contentTypes['jobsIdFormValidatePost'][0])
    {
        ...
        if (isset($jobs_id_form_validate_post_request)) {
            if (stripos($headers['Content-Type'], 'application/json') !== false) {
                # if Content-Type contains "application/json", json_encode the body
                if(PHP_VERSION_ID < 70200){
                    $httpBody = \GuzzleHttp\json_encode(ObjectSerializer::sanitizeForSerialization($jobs_id_form_validate_post_request));
                } else {
     ...
     * @throws \RecruitisApi\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return mixed[]|int|object|null|\RecruitisApi\Model\JobsIdGet200Response|\RecruitisApi\Model\LoginPut401Response|\RecruitisApi\Model\JobsIdGet404Response
     */
     ...
     * @throws \RecruitisApi\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array<mixed[]|int|object|null|\RecruitisApi\Model\JobsIdGet200Response|\RecruitisApi\Model\LoginPut401Response|\RecruitisApi\Model\JobsIdGet404Response> array of \RecruitisApi\Model\JobsIdGet200Response|\RecruitisApi\Model\LoginPut401Response|\RecruitisApi\Model\JobsIdGet404Response, HTTP status code, HTTP response headers (array of strings)
     */
    public function jobsIdGetWithHttpInfo($id, $with_automation = null, $activity_state = null, $access_state = null, string $contentType = self::contentTypes['jobsIdGet'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\RecruitisApi\Model\JobsIdGet200Response' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\RecruitisApi\Model\JobsIdGet200Response' !== 'string') {
                            try {
                                if(defined('JSON_THROW_ON_ERROR')){
                                    $content = json_decode($content, false, 512, JSON_THROW_ON_ERROR);
                                } else {
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\RecruitisApi\Model\JobsIdGet200Response', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                case 401:
            ...
            $returnType = '\RecruitisApi\Model\JobsIdGet200Response';
            if ($returnType === '\SplFileObject') {
                $content = $response->getBody(); //stream goes to serializer
            } else {
                $content = (string) $response->getBody();
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\RecruitisApi\Model\JobsIdGet200Response',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     *
     * @param  int $id id (required)
     * @param  \RecruitisApi\Model\JobsIdRecommendApplicantPostRequest $jobs_id_recommend_applicant_post_request jobs_id_recommend_applicant_post_request (optional)
     ...
     * @throws \RecruitisApi\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return mixed[]|int|object|null|\RecruitisApi\Model\JobsIdRecommendApplicantPost201Response|\RecruitisApi\Model\LoginPut401Response|\RecruitisApi\Model\JobsIdGet404Response
     */
     ...
     *
     * @param  int $id (required)
     * @param  \RecruitisApi\Model\JobsIdRecommendApplicantPostRequest $jobs_id_recommend_applicant_post_request (optional)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['jobsIdRecommendApplicantPost'] to see the possible values for this operation
     *
     * @throws \RecruitisApi\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array<mixed[]|int|object|null|\RecruitisApi\Model\JobsIdRecommendApplicantPost201Response|\RecruitisApi\Model\LoginPut401Response|\RecruitisApi\Model\JobsIdGet404Response> array of \RecruitisApi\Model\JobsIdRecommendApplicantPost201Response|\RecruitisApi\Model\LoginPut401Response|\RecruitisApi\Model\JobsIdGet404Response, HTTP status code, HTTP response headers (array of strings)
     */
    public function jobsIdRecommendApplicantPostWithHttpInfo($id, $jobs_id_recommend_applicant_post_request = null, string $contentType = self::contentTypes['jobsIdRecommendApplicantPost'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 201:
                    if ('\RecruitisApi\Model\JobsIdRecommendApplicantPost201Response' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\RecruitisApi\Model\JobsIdRecommendApplicantPost201Response' !== 'string') {
                            try {
                                if(defined('JSON_THROW_ON_ERROR')){
                                    $content = json_decode($content, false, 512, JSON_THROW_ON_ERROR);
                                } else {
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\RecruitisApi\Model\JobsIdRecommendApplicantPost201Response', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                case 401:
            ...
            $returnType = '\RecruitisApi\Model\JobsIdRecommendApplicantPost201Response';
            if ($returnType === '\SplFileObject') {
                $content = $response->getBody(); //stream goes to serializer
            } else {
                $content = (string) $response->getBody();
            ...
            switch ($e->getCode()) {
                case 201:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\RecruitisApi\Model\JobsIdRecommendApplicantPost201Response',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
    ...
    public function jobsIdRecommendApplicantPostRequest($id, $jobs_id_recommend_applicant_post_request = null, string $contentType = self::contentTypes['jobsIdRecommendApplicantPost'][0])
    {
        ...
        if (isset($jobs_id_recommend_applicant_post_request)) {
            if (stripos($headers['Content-Type'], 'application/json') !== false) {
                # if Content-Type contains "application/json", json_encode the body
                if(PHP_VERSION_ID < 70200){
                    $httpBody = \GuzzleHttp\json_encode(ObjectSerializer::sanitizeForSerialization($jobs_id_recommend_applicant_post_request));
                } else {
     ...
     * Create new job
     *
     * @param  \RecruitisApi\Model\JobsPostRequest $jobs_post_request jobs_post_request (optional)
     ...
     * @throws \RecruitisApi\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return mixed[]|int|object|null|\RecruitisApi\Model\JobsPost201Response|\RecruitisApi\Model\JobsPost400Response
     */
     ...
     * Create new job
     *
     * @param  \RecruitisApi\Model\JobsPostRequest $jobs_post_request (optional)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['jobsPost'] to see the possible values for this operation
     *
     * @throws \RecruitisApi\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array<mixed[]|int|object|null|\RecruitisApi\Model\JobsPost201Response|\RecruitisApi\Model\JobsPost400Response> array of \RecruitisApi\Model\JobsPost201Response|\RecruitisApi\Model\JobsPost400Response, HTTP status code, HTTP response headers (array of strings)
     */
    public function jobsPostWithHttpInfo($jobs_post_request = null, string $contentType = self::contentTypes['jobsPost'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 201:
                    if ('\RecruitisApi\Model\JobsPost201Response' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\RecruitisApi\Model\JobsPost201Response' !== 'string') {
                            try {
                                if(defined('JSON_THROW_ON_ERROR')){
                                    $content = json_decode($content, false, 512, JSON_THROW_ON_ERROR);
                                } else {
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\RecruitisApi\Model\JobsPost201Response', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                case 400:
            ...
            $returnType = '\RecruitisApi\Model\JobsPost201Response';
            if ($returnType === '\SplFileObject') {
                $content = $response->getBody(); //stream goes to serializer
            } else {
                $content = (string) $response->getBody();
            ...
            switch ($e->getCode()) {
                case 201:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\RecruitisApi\Model\JobsPost201Response',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
    ...
    public function jobsPostRequest($jobs_post_request = null, string $contentType = self::contentTypes['jobsPost'][0])
    {
        ...
        if (isset($jobs_post_request)) {
            if (stripos($headers['Content-Type'], 'application/json') !== false) {
                # if Content-Type contains "application/json", json_encode the body
                if(PHP_VERSION_ID < 70200){
                    $httpBody = \GuzzleHttp\json_encode(ObjectSerializer::sanitizeForSerialization($jobs_post_request));
                } else {
