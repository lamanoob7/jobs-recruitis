...
class MeApi
{
     ...
     * @return mixed[]|int|object|null|\RecruitisApi\Model\MeGet200Response|\RecruitisApi\Model\LoginPut401Response
     */
     ...
     * @throws \RecruitisApi\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array<mixed[]|int|object|null|\RecruitisApi\Model\MeGet200Response|\RecruitisApi\Model\LoginPut401Response> array of \RecruitisApi\Model\MeGet200Response|\RecruitisApi\Model\LoginPut401Response, HTTP status code, HTTP response headers (array of strings)
     */
    public function meGetWithHttpInfo(string $contentType = self::contentTypes['meGet'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\RecruitisApi\Model\MeGet200Response' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\RecruitisApi\Model\MeGet200Response' !== 'string') {
                            try {
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\RecruitisApi\Model\MeGet200Response', []),
            ...
            $returnType = '\RecruitisApi\Model\MeGet200Response';
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\RecruitisApi\Model\MeGet200Response',
