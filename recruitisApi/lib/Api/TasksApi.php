...
class TasksApi
{
     ...
     * @return mixed[]|int|object|null|\RecruitisApi\Model\TasksGet200Response|\RecruitisApi\Model\LoginPut401Response
     */
    public function tasksGet(string $contentType = self::contentTypes['tasksGet'][0])
    {
        list($response) = $this->tasksGetWithHttpInfo($contentType);
        return $response;
    }
     ...
     * @throws \RecruitisApi\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array<mixed[]|int|object|null|\RecruitisApi\Model\TasksGet200Response|\RecruitisApi\Model\LoginPut401Response> array of \RecruitisApi\Model\TasksGet200Response|\RecruitisApi\Model\LoginPut401Response, HTTP status code, HTTP response headers (array of strings)
     */
    public function tasksGetWithHttpInfo(string $contentType = self::contentTypes['tasksGet'][0])
    {
        $request = $this->tasksGetRequest($contentType);
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\RecruitisApi\Model\TasksGet200Response' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\RecruitisApi\Model\TasksGet200Response' !== 'string') {
                            try {
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\RecruitisApi\Model\TasksGet200Response', []),
            ...
            $returnType = '\RecruitisApi\Model\TasksGet200Response';
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\RecruitisApi\Model\TasksGet200Response',
     ...
     */
    public function tasksGetAsync(string $contentType = self::contentTypes['tasksGet'][0])
    {
        return $this->tasksGetAsyncWithHttpInfo($contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function tasksGetAsyncWithHttpInfo(string $contentType = self::contentTypes['tasksGet'][0])
    {
        $returnType = '\RecruitisApi\Model\TasksGet200Response';
        $request = $this->tasksGetRequest($contentType);
     ...
     */
    public function tasksGetRequest(string $contentType = self::contentTypes['tasksGet'][0])
    {
