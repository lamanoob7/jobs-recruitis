<?php
/**
 * CalendarReservationLinksPostRequest
 *
 * PHP version 7.4
 *
 * @category Class
...
/**
 * CalendarReservationLinksPostRequest Class Doc Comment
 *
 * @category Class
 * @package  App\Module\RecruitisApi
 * @author   OpenAPI Generator team
 ...
 */
class CalendarReservationLinksPostRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = '_calendar_reservation_links_post_request';
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['reservation_link_id'] === null) {
            $invalidProperties[] = "'reservation_link_id' can't be null";
        }
     ...
     *
     * @param int $reservation_link_id reservation_link_id
     *
     * @return self
     */
