<?php
/**
 * AnswersGet200ResponseOneOf1PayloadInnerRejectReasonInner
 *
 * PHP version 7.4
 *
 * @category Class
...
/**
 * AnswersGet200ResponseOneOf1PayloadInnerRejectReasonInner Class Doc Comment
 *
 * @category Class
 * @package  App\Module\RecruitisApi
 * @author   OpenAPI Generator team
 ...
 */
class AnswersGet200ResponseOneOf1PayloadInnerRejectReasonInner implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = '_answers_get_200_response_oneOf_1_payload_inner_reject_reason_inner';
    ...
    */
     ...
     * Sets id
     *
     * @param int|null $id ID důvodu zamítnutí
     *
     * @return self
     */
     ...
     * Sets type
     *
     * @param string|null $type Typ důvodu zamítnutí (candidate - na straně kandidáta, company - firemní důvod, agency - agenturní důvod)
     *
     * @return self
     */
     ...
     * Sets name
     *
     * @param string|null $name Důvod zamítnutí kandidáta.
     *
     * @return self
     */
