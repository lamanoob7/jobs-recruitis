<?php
/**
 * EnumsWorkfieldsGet200ResponseOneOf1PayloadInner
 *
 * PHP version 7.4
 *
 * @category Class
...
/**
 * EnumsWorkfieldsGet200ResponseOneOf1PayloadInner Class Doc Comment
 *
 * @category Class
 * @package  App\Module\RecruitisApi
 * @author   OpenAPI Generator team
 ...
 */
class EnumsWorkfieldsGet200ResponseOneOf1PayloadInner implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = '_enums_workfields_get_200_response_oneOf_1_payload_inner';
    ...
    protected static $openAPITypes = [
        ...
        'name' => 'string',
        'count' => 'int',
        'professions' => '\App\Module\RecruitisApi\Model\EnumsWorkfieldsGet200ResponseOneOf1PayloadInnerProfessionsInner[]'
    ];
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('professions', $data ?? [], null);
    }
    ...
    */
     ...
     * Gets professions
     *
     * @return \App\Module\RecruitisApi\Model\EnumsWorkfieldsGet200ResponseOneOf1PayloadInnerProfessionsInner[]|null
     */
    public function getProfessions()
    {
        return $this->container['professions'];
    }

    /**
     * Sets professions
     *
     * @param \App\Module\RecruitisApi\Model\EnumsWorkfieldsGet200ResponseOneOf1PayloadInnerProfessionsInner[]|null $professions professions
     *
     * @return self
     */
    public function setProfessions($professions)
    {
        if (is_null($professions)) {
            throw new \InvalidArgumentException('non-nullable professions cannot be null');
        }
        $this->container['professions'] = $professions;
