...
/**
 * MeGet200ResponsePayloadQuotas Class Doc Comment
 *
 * @category Class
 * @package  App\Module\RecruitisApi
 * @author   OpenAPI Generator team
 ...
 */
class MeGet200ResponsePayloadQuotas implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = '_me_get_200_response_payload_quotas';
    ...
    protected static $openAPITypes = [
        'daily_quota_candidates_delete' => 'int'
    ];
    ...
    protected static $openAPIFormats = [
        'daily_quota_candidates_delete' => null
    ];
    ...
    protected static array $openAPINullables = [
        'daily_quota_candidates_delete' => false
    ];
    ...
    protected static $attributeMap = [
        'daily_quota_candidates_delete' => 'daily_quota_candidates_delete'
    ];
    ...
    protected static $setters = [
        'daily_quota_candidates_delete' => 'setDailyQuotaCandidatesDelete'
    ];
    ...
    protected static $getters = [
        'daily_quota_candidates_delete' => 'getDailyQuotaCandidatesDelete'
    ];
    ...
    {
        $this->setIfExists('daily_quota_candidates_delete', $data ?? [], null);
    }
    ...
    */
    ...
    /**
     * Gets daily_quota_candidates_delete
     *
     * @return int|null
     */
    public function getDailyQuotaCandidatesDelete()
    {
        return $this->container['daily_quota_candidates_delete'];
    }

    /**
     * Sets daily_quota_candidates_delete
     *
     * @param int|null $daily_quota_candidates_delete daily_quota_candidates_delete
     *
     * @return self
     */
    public function setDailyQuotaCandidatesDelete($daily_quota_candidates_delete)
    {
        if (is_null($daily_quota_candidates_delete)) {
            throw new \InvalidArgumentException('non-nullable daily_quota_candidates_delete cannot be null');
        }
        $this->container['daily_quota_candidates_delete'] = $daily_quota_candidates_delete;
