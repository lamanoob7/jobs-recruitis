<?php
/**
 * JobsIdAccessStateStatePut200ResponsePayload
 *
 * PHP version 7.4
 *
 * @category Class
...
/**
 * JobsIdAccessStateStatePut200ResponsePayload Class Doc Comment
 *
 * @category Class
 * @package  App\Module\RecruitisApi
 * @author   OpenAPI Generator team
 ...
 */
class JobsIdAccessStateStatePut200ResponsePayload implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = '_jobs__id__access_state__state__put_200_response_payload';
    ...
    */
     ...
     * Sets access_state
     *
     * @param int|null $access_state access_state
     *
     * @return self
     */
