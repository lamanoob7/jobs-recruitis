...
/**
 * JobsIdAccessPutRequest Class Doc Comment
 *
 * @category Class
 * @package  App\Module\RecruitisApi
 * @author   OpenAPI Generator team
 ...
 */
class JobsIdAccessPutRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = '_jobs__id__access_put_request';
    ...
    */
     ...
     * Sets referral
     *
     * @param string|null $referral ID referrala, kterému se zobrazení inzerátu připočte.
     *
     * @return self
     */
     ...
     * Sets ip
     *
     * @param string $ip IP adresa, která inzerát navštívila.
     *
     * @return self
     */
     ...
     * Sets token
     *
     * @param string $token Náhodný hash, který je jednou vygenerován a poté by měl být uložen v cookies stránky a posílat se vždy s ostatními informacemi.
     *
     * @return self
     */
     ...
     * Sets referer
     *
     * @param string|null $referer Url adresa, z které návštěvník přišel.
     *
     * @return self
     */
