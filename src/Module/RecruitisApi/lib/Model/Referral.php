...
class Referral implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('date_visisted', $data ?? [], null);
    ...
    */
     ...
     * Sets id
     *
     * @param string|null $id ID referrala.
     *
     * @return self
     */
     ...
     * Sets access_id
     *
     * @param string|null $access_id Veřejné ID referrala, přes který má přístup ke svému portálu, viz `url` parametr.
     *
     * @return self
     */
     ...
     * Sets name
     *
     * @param string|null $name Jméno referrala.
     *
     * @return self
     */
     ...
     * Sets date_created
     *
     * @param \DateTime|null $date_created Datum vzniku referrala.
     *
     * @return self
     */
     ...
     * @return \DateTime|null
     */
    public function getDateVisisted()
    {
        return $this->container['date_visisted'];
    }

    /**
     * Sets date_visisted
     *
     * @param \DateTime|null $date_visisted Datum, kdy naposledy referral navštívil svojí stránku.
     *
     * @return self
     */
    public function setDateVisisted($date_visisted)
    {
        if (is_null($date_visisted)) {
            throw new \InvalidArgumentException('non-nullable date_visisted cannot be null');
        }
        $this->container['date_visisted'] = $date_visisted;
     ...
     * Sets email
     *
     * @param string|null $email Email referrala.
     *
     * @return self
     */
     ...
     * Sets url
     *
     * @param string|null $url Odkaz na adresu stránky referrala.
     *
     * @return self
     */
