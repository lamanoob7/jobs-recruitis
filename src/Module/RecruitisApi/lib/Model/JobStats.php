 ...
 */
class JobStats implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'Job_stats';
    ...
    protected static $openAPITypes = [
        'answers' => 'int',
        'views' => 'int',
        'flow_answers' => '\App\Module\RecruitisApi\Model\JobStatsFlowAnswersInner[]'
    ];
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('flow_answers', $data ?? [], null);
    }
    ...
    */
     ...
     * Sets answers
     *
     * @param int|null $answers answers
     *
     * @return self
     */
     ...
     * Gets flow_answers
     *
     * @return \App\Module\RecruitisApi\Model\JobStatsFlowAnswersInner[]|null
     */
    public function getFlowAnswers()
    {
        return $this->container['flow_answers'];
    }

    /**
     * Sets flow_answers
     *
     * @param \App\Module\RecruitisApi\Model\JobStatsFlowAnswersInner[]|null $flow_answers flow_answers
     *
     * @return self
     */
    public function setFlowAnswers($flow_answers)
    {
        if (is_null($flow_answers)) {
            throw new \InvalidArgumentException('non-nullable flow_answers cannot be null');
        }
        $this->container['flow_answers'] = $flow_answers;
