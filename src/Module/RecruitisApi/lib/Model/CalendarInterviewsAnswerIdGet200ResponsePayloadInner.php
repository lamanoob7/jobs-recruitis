<?php
/**
 * CalendarInterviewsAnswerIdGet200ResponsePayloadInner
 *
 * PHP version 7.4
 *
 * @category Class
...
/**
 * CalendarInterviewsAnswerIdGet200ResponsePayloadInner Class Doc Comment
 *
 * @category Class
 * @package  App\Module\RecruitisApi
 * @author   OpenAPI Generator team
 ...
 */
class CalendarInterviewsAnswerIdGet200ResponsePayloadInner implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = '_calendar_interviews__answer_id__get_200_response_payload_inner';
    ...
    protected static $openAPITypes = [
        'event' => '\App\Module\RecruitisApi\Model\CalendarInterviewsAnswerIdGet200ResponsePayloadInnerEvent',
        'reservation_link' => '\App\Module\RecruitisApi\Model\CalendarInterviewsAnswerIdGet200ResponsePayloadInnerReservationLink'
    ];
    ...
    protected static $setters = [
        'event' => 'setEvent',
        'reservation_link' => 'setReservationLink'
    ];
    ...
    protected static $getters = [
        'event' => 'getEvent',
        'reservation_link' => 'getReservationLink'
    ];
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('reservation_link', $data ?? [], null);
    }
    ...
    */
     ...
     * Gets event
     *
     * @return \App\Module\RecruitisApi\Model\CalendarInterviewsAnswerIdGet200ResponsePayloadInnerEvent|null
     */
     ...
     * Sets event
     *
     * @param \App\Module\RecruitisApi\Model\CalendarInterviewsAnswerIdGet200ResponsePayloadInnerEvent|null $event event
     *
     * @return self
     */
    ...
    /**
     * Gets reservation_link
     *
     * @return \App\Module\RecruitisApi\Model\CalendarInterviewsAnswerIdGet200ResponsePayloadInnerReservationLink|null
     */
    public function getReservationLink()
    {
        return $this->container['reservation_link'];
    }

    /**
     * Sets reservation_link
     *
     * @param \App\Module\RecruitisApi\Model\CalendarInterviewsAnswerIdGet200ResponsePayloadInnerReservationLink|null $reservation_link reservation_link
     *
     * @return self
     */
    public function setReservationLink($reservation_link)
    {
        if (is_null($reservation_link)) {
            array_push($this->openAPINullablesSetToNull, 'reservation_link');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('reservation_link', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
        }
        $this->container['reservation_link'] = $reservation_link;
