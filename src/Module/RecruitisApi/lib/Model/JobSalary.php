 ...
 */
class JobSalary implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'Job_salary';
    ...
    protected static $attributeMap = [
        'is_range' => 'is_range',
        'is_min_visible' => 'is_min_visible',
        'is_max_visible' => 'is_max_visible',
        'min' => 'min',
        'max' => 'max',
        'currency' => 'currency',
        'unit' => 'unit',
    ...
    protected static $setters = [
        'is_range' => 'setIsRange',
        'is_min_visible' => 'setIsMinVisible',
        'is_max_visible' => 'setIsMaxVisible',
        'min' => 'setMin',
        'max' => 'setMax',
    ...
    protected static $getters = [
        'is_range' => 'getIsRange',
        'is_min_visible' => 'getIsMinVisible',
        'is_max_visible' => 'getIsMaxVisible',
        'min' => 'getMin',
        'max' => 'getMax',
    ...
    public const UNIT_MANDAY = 'manday';
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('is_min_visible', $data ?? [], null);
        $this->setIfExists('is_max_visible', $data ?? [], null);
    ...
    */
     ...
     * @return bool|null
     */
    public function getIsMinVisible()
    {
        return $this->container['is_min_visible'];
    }

    /**
     * Sets is_min_visible
     *
     * @param bool|null $is_min_visible is_min_visible
     *
     * @return self
     */
    public function setIsMinVisible($is_min_visible)
    {
        if (is_null($is_min_visible)) {
            throw new \InvalidArgumentException('non-nullable is_min_visible cannot be null');
        }
        $this->container['is_min_visible'] = $is_min_visible;
     ...
     * @return bool|null
     */
    public function getIsMaxVisible()
    {
        return $this->container['is_max_visible'];
    }

    /**
     * Sets is_max_visible
     *
     * @param bool|null $is_max_visible is_max_visible
     *
     * @return self
     */
    public function setIsMaxVisible($is_max_visible)
    {
        if (is_null($is_max_visible)) {
            throw new \InvalidArgumentException('non-nullable is_max_visible cannot be null');
        }
        $this->container['is_max_visible'] = $is_max_visible;
     ...
     * Sets min
     *
     * @param float|null $min Platové ohodnocení - minimální hranice.
     *
     * @return self
     */
     ...
     * Sets max
     *
     * @param float|null $max Platové ohodnocení - maximální hranice.
     *
     * @return self
     */
     ...
     * Sets unit
     *
     * @param string|null $unit Typ platu
     *
     * @return self
     */
     ...
     * Sets visible
     *
     * @param bool|null $visible Určuje, jestli je tato informace veřejná. Nově vrací true pokud: (is_range && is_min_visible) || is_max_visible
     *
     * @return self
     */
