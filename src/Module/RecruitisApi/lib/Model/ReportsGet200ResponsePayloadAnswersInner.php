<?php
/**
 * ReportsGet200ResponsePayloadAnswersInner
 *
 * PHP version 7.4
 *
 * @category Class
...
/**
 * ReportsGet200ResponsePayloadAnswersInner Class Doc Comment
 *
 * @category Class
 * @package  App\Module\RecruitisApi
 * @author   OpenAPI Generator team
 ...
 */
class ReportsGet200ResponsePayloadAnswersInner implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = '_reports_get_200_response_payload_answers_inner';
    ...
    protected static $openAPITypes = [
        ...
        'offer_acceptation_status' => 'string',
        'sex' => 'string',
        'nationality' => 'string',
        'job_id' => 'int',
        'job_title' => 'string',
        'salary' => '\App\Module\RecruitisApi\Model\ReportsGet200ResponsePayloadAnswersInnerSalary',
        'hiring_proposal' => '\App\Module\RecruitisApi\Model\ReportsGet200ResponsePayloadAnswersInnerSalary',
        'interviews' => '\App\Module\RecruitisApi\Model\ReportsGet200ResponsePayloadAnswersInnerInterviewsInner[]'
    ];
    ...
    protected static $openAPIFormats = [
        ...
        'rejected' => null,
        'reject_reason' => null,
        'offer_acceptation_status' => null,
        'sex' => null,
        'nationality' => null,
        'job_id' => null,
        'job_title' => null,
        'salary' => null,
        'hiring_proposal' => null,
        'interviews' => null
    ];
    ...
    protected static array $openAPINullables = [
        ...
        'rejected' => false,
        'reject_reason' => false,
        'offer_acceptation_status' => false,
        'sex' => false,
        'nationality' => false,
        'job_id' => false,
        'job_title' => false,
        'salary' => true,
        'hiring_proposal' => true,
        'interviews' => false
    ];
    ...
    protected static $attributeMap = [
        ...
        'offer_acceptation_status' => 'OfferAcceptationStatus',
        'sex' => 'Sex',
        'nationality' => 'Nationality',
        'job_id' => 'JobID',
        'job_title' => 'JobTitle',
        'salary' => 'Salary',
        'hiring_proposal' => 'HiringProposal',
    ...
    protected static $setters = [
        ...
        'offer_acceptation_status' => 'setOfferAcceptationStatus',
        'sex' => 'setSex',
        'nationality' => 'setNationality',
        'job_id' => 'setJobId',
        'job_title' => 'setJobTitle',
        'salary' => 'setSalary',
        'hiring_proposal' => 'setHiringProposal',
    ...
    protected static $getters = [
        ...
        'offer_acceptation_status' => 'getOfferAcceptationStatus',
        'sex' => 'getSex',
        'nationality' => 'getNationality',
        'job_id' => 'getJobId',
        'job_title' => 'getJobTitle',
        'salary' => 'getSalary',
        'hiring_proposal' => 'getHiringProposal',
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('offer_acceptation_status', $data ?? [], null);
        ...
        $this->setIfExists('hiring_proposal', $data ?? [], null);
    ...
    */
     ...
     *
     * @param string|null $additional_source additional_source
     *
     * @return self
     */
    ...
    /**
     * Gets offer_acceptation_status
     *
     * @return string|null
     */
    public function getOfferAcceptationStatus()
    {
        return $this->container['offer_acceptation_status'];
    }

    /**
     * Sets offer_acceptation_status
     *
     * @param string|null $offer_acceptation_status offer_acceptation_status
     *
     * @return self
     */
    public function setOfferAcceptationStatus($offer_acceptation_status)
    {
        if (is_null($offer_acceptation_status)) {
            throw new \InvalidArgumentException('non-nullable offer_acceptation_status cannot be null');
        }
        $this->container['offer_acceptation_status'] = $offer_acceptation_status;
     ...
     * Gets salary
     *
     * @return \App\Module\RecruitisApi\Model\ReportsGet200ResponsePayloadAnswersInnerSalary|null
     */
     ...
     * Sets salary
     *
     * @param \App\Module\RecruitisApi\Model\ReportsGet200ResponsePayloadAnswersInnerSalary|null $salary salary
     *
     * @return self
     */
    ...
    /**
     * Gets hiring_proposal
     *
     * @return \App\Module\RecruitisApi\Model\ReportsGet200ResponsePayloadAnswersInnerSalary|null
     */
    public function getHiringProposal()
    {
        return $this->container['hiring_proposal'];
    }

    /**
     * Sets hiring_proposal
     *
     * @param \App\Module\RecruitisApi\Model\ReportsGet200ResponsePayloadAnswersInnerSalary|null $hiring_proposal hiring_proposal
     *
     * @return self
     */
    public function setHiringProposal($hiring_proposal)
    {
        if (is_null($hiring_proposal)) {
            array_push($this->openAPINullablesSetToNull, 'hiring_proposal');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('hiring_proposal', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
        }
        $this->container['hiring_proposal'] = $hiring_proposal;
     ...
     * Gets interviews
     *
     * @return \App\Module\RecruitisApi\Model\ReportsGet200ResponsePayloadAnswersInnerInterviewsInner[]|null
     */
     ...
     * Sets interviews
     *
     * @param \App\Module\RecruitisApi\Model\ReportsGet200ResponsePayloadAnswersInnerInterviewsInner[]|null $interviews interviews
     *
     * @return self
     */
