...
/**
 * CandidatesIdAnswerIdCommunicationPostRequest Class Doc Comment
 *
 * @category Class
 * @package  App\Module\RecruitisApi
 * @author   OpenAPI Generator team
 ...
 */
class CandidatesIdAnswerIdCommunicationPostRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = '_candidates__id___answer_id__communication_post_request';
    ...
    protected static $openAPITypes = [
        ...
        'type' => 'string',
        'strict' => 'bool',
        'attachments' => '\App\Module\RecruitisApi\Model\AttachmentsInner[]'
    ];
    ...
    public const SENDER_TYPE_CANDIDATE = 'candidate';
    public const SENDER_TYPE_EMPLOYEE = 'employee';
    ...
    public const TYPE_SYSEMAIL = 'sysemail';
    ...
    {
        return [
            self::SENDER_TYPE_CANDIDATE,
            self::SENDER_TYPE_EMPLOYEE,
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('date_action', $data ?? [], null);
    ...
    */
     ...
     * Sets employee_id
     *
     * @param int $employee_id ID uživatele, který zprávu posílá.
     *
     * @return self
     */
     ...
     * Sets author_id
     *
     * @param int|null $author_id ID uživatele, vyplňte, pokud je autor jiný uživatel, než ten, který zprávu posílá. Pokud nevyplněno, použije se employee_id.
     *
     * @return self
     */
     ...
     * Sets sender
     *
     * @param string|null $sender Textová podoba odesílatele (jméno, email, telefoní číslo (SMS)), pokud nebude vyplněno, použijí se data vázaná na author_id.
     *
     * @return self
     */
     ...
     * Sets sender_type
     *
     * @param string $sender_type Říká, od koho pochází daná komunikace. Přípustné hodnoty: candidate, employee, system, other
     *
     * @return self
     */
     ...
     * Sets recipient
     *
     * @param string|null $recipient Dtto. sender
     *
     * @return self
     */
     ...
     * Sets direction
     *
     * @param string $direction Jedna z hodnot: in = příchozí, out = odchozí, váže se ke kandidátovi/odpovědi.     Tj. příchozí ke kandidátovi a odchozí od kandidáta.
     *
     * @return self
     */
    ...
    {
        return $this->container['date_action'];
    }

    /**
     * Sets date_action
     *
     * @param \DateTime|null $date_action Datum vytvoření komunikace.
     *
     * @return self
     */
    public function setDateAction($date_action)
    {
        if (is_null($date_action)) {
            throw new \InvalidArgumentException('non-nullable date_action cannot be null');
        }
        $this->container['date_action'] = $date_action;
     ...
     * Sets strict
     *
     * @param bool|null $strict Určuje chování uploadu při chybě, pokud 1, tak se uloží vše, nebo nic. Pokud 0, v meta tagu budou informace o neuložených přílohách.
     *
     * @return self
     */
     ...
     * Gets attachments
     *
     * @return \App\Module\RecruitisApi\Model\AttachmentsInner[]|null
     */
     ...
     * Sets attachments
     *
     * @param \App\Module\RecruitisApi\Model\AttachmentsInner[]|null $attachments Velikost souboru nesmí přesáhnout 4MB.  #### Všechny typy příloh naleznete v sekci [\"Dodatečný popis API volání - Typy příloh\"](#typy-příloh-attachment-type)
     *
     * @return self
     */
