<?php
/**
 * JobsIdChannelChannelIdPutRequest
 *
 * PHP version 7.4
 *
 * @category Class
...
/**
 * JobsIdChannelChannelIdPutRequest Class Doc Comment
 *
 * @category Class
 * @package  App\Module\RecruitisApi
 * @author   OpenAPI Generator team
 ...
 */
class JobsIdChannelChannelIdPutRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = '_jobs__id__channel__channel_id__put_request';
    ...
    */
     ...
     * Sets date_from
     *
     * @param \DateTime $date_from Formát YYYY-mm-dd HH:mm:ss Datum, od kdy má být inzerát na daném kanále vystaven. Pokud není vyplněno, použije se aktuální datum a čas.
     *
     * @return self
     */
     ...
     * Sets date_to
     *
     * @param \DateTime $date_to Formát YYYY-mm-dd HH:mm:ss Datum, do kdy má být inzerát na daném kanále vystaven.
     *
     * @return self
     */
