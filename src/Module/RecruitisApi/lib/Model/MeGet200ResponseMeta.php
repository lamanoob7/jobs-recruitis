...
/**
 * MeGet200ResponseMeta Class Doc Comment
 *
 * @category Class
 * @package  App\Module\RecruitisApi
 * @author   OpenAPI Generator team
 ...
 */
class MeGet200ResponseMeta implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = '_me_get_200_response_meta';
