<?php
/**
 * CalendarInterviewsAnswerIdGet200ResponsePayloadInnerEvent
 *
 * PHP version 7.4
 *
 * @category Class
...
/**
 * CalendarInterviewsAnswerIdGet200ResponsePayloadInnerEvent Class Doc Comment
 *
 * @category Class
 * @package  App\Module\RecruitisApi
 * @author   OpenAPI Generator team
 ...
 */
class CalendarInterviewsAnswerIdGet200ResponsePayloadInnerEvent implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = '_calendar_interviews__answer_id__get_200_response_payload_inner_event';
    ...
    protected static $openAPIFormats = [
        ...
        'title' => null,
        'type' => null,
        'datetime_from' => 'date-time',
        'datetime_to' => 'date-time',
        'meeting_url' => null
    ];
    ...
    protected static $setters = [
        ...
        'title' => 'setTitle',
        'type' => 'setType',
        'datetime_from' => 'setDatetimeFrom',
        'datetime_to' => 'setDatetimeTo',
        'meeting_url' => 'setMeetingUrl'
    ];
    ...
    protected static $getters = [
        ...
        'title' => 'getTitle',
        'type' => 'getType',
        'datetime_from' => 'getDatetimeFrom',
        'datetime_to' => 'getDatetimeTo',
        'meeting_url' => 'getMeetingUrl'
    ];
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('datetime_from', $data ?? [], null);
        $this->setIfExists('datetime_to', $data ?? [], null);
        $this->setIfExists('meeting_url', $data ?? [], null);
    }
    ...
    */
     ...
     * Sets title
     *
     * @param string|null $title Název události v kalendáři.
     *
     * @return self
     */
     ...
     * Sets type
     *
     * @param string|null $type Zvolený typ schůzky.
     *
     * @return self
     */
    ...
    {
        return $this->container['datetime_from'];
    }

    /**
     * Sets datetime_from
     *
     * @param \DateTime|null $datetime_from datetime_from
     *
     * @return self
     */
    public function setDatetimeFrom($datetime_from)
    {
        if (is_null($datetime_from)) {
            throw new \InvalidArgumentException('non-nullable datetime_from cannot be null');
        }
        $this->container['datetime_from'] = $datetime_from;
    ...
    {
        return $this->container['datetime_to'];
    }

    /**
     * Sets datetime_to
     *
     * @param \DateTime|null $datetime_to datetime_to
     *
     * @return self
     */
    public function setDatetimeTo($datetime_to)
    {
        if (is_null($datetime_to)) {
            throw new \InvalidArgumentException('non-nullable datetime_to cannot be null');
        }
        $this->container['datetime_to'] = $datetime_to;
    ...
    {
        return $this->container['meeting_url'];
    }

    /**
     * Sets meeting_url
     *
     * @param string|null $meeting_url Odkaz na online meeting
     *
     * @return self
     */
    public function setMeetingUrl($meeting_url)
    {
        if (is_null($meeting_url)) {
            array_push($this->openAPINullablesSetToNull, 'meeting_url');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('meeting_url', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
        }
        $this->container['meeting_url'] = $meeting_url;
