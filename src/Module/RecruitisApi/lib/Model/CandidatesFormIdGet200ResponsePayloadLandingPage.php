<?php
/**
 * CandidatesFormIdGet200ResponsePayloadLandingPage
 *
 * PHP version 7.4
 *
 * @category Class
...
/**
 * CandidatesFormIdGet200ResponsePayloadLandingPage Class Doc Comment
 *
 * @category Class
 * @package  App\Module\RecruitisApi
 * @author   OpenAPI Generator team
 ...
 */
class CandidatesFormIdGet200ResponsePayloadLandingPage implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = '_candidates_form__id__get_200_response_payload_landing_page';
    ...
    */
     ...
     * Sets description
     *
     * @param string|null $description HTML content pro landing page
     *
     * @return self
     */
     ...
     * Sets footer
     *
     * @param string|null $footer HTML footer pro landing page
     *
     * @return self
     */
