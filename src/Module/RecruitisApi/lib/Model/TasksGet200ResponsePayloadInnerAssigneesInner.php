<?php
/**
 * TasksGet200ResponsePayloadInnerAssigneesInner
 *
 * PHP version 7.4
 *
 * @category Class
...
/**
 * TasksGet200ResponsePayloadInnerAssigneesInner Class Doc Comment
 *
 * @category Class
 * @package  App\Module\RecruitisApi
 * @author   OpenAPI Generator team
 ...
 */
class TasksGet200ResponsePayloadInnerAssigneesInner implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = '_tasks_get_200_response_payload_inner_assignees_inner';
