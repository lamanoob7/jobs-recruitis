...
class Webhook implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        'header' => '\App\Module\RecruitisApi\Model\WebhookHeader',
        'body' => 'object'
    ];
    ...
    */
     ...
     * Gets header
     *
     * @return \App\Module\RecruitisApi\Model\WebhookHeader|null
     */
     ...
     * Sets header
     *
     * @param \App\Module\RecruitisApi\Model\WebhookHeader|null $header header
     *
     * @return self
     */
