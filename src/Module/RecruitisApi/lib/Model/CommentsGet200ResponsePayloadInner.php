<?php
/**
 * CommentsGet200ResponsePayloadInner
 *
 * PHP version 7.4
 *
 * @category Class
...
/**
 * CommentsGet200ResponsePayloadInner Class Doc Comment
 *
 * @category Class
 * @package  App\Module\RecruitisApi
 * @author   OpenAPI Generator team
 ...
 */
class CommentsGet200ResponsePayloadInner implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = '_comments_get_200_response_payload_inner';
    ...
    protected static $openAPITypes = [
        'id' => 'int',
        'candidate' => '\App\Module\RecruitisApi\Model\CommentsGet200ResponsePayloadInnerCandidate',
        'body' => 'string',
        'has_feedback' => 'bool',
        'author' => 'string',
        ...
        'tags' => '\App\Module\RecruitisApi\Model\CommentsGet200ResponsePayloadInnerTagsInner[]'
    ];
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('has_feedback', $data ?? [], null);
        $this->setIfExists('author', $data ?? [], null);
        $this->setIfExists('author_avatar', $data ?? [], null);
        $this->setIfExists('author_initials', $data ?? [], null);
        $this->setIfExists('author_id', $data ?? [], null);
        $this->setIfExists('date_created', $data ?? [], null);
        $this->setIfExists('date_edited', $data ?? [], null);
    ...
    */
     ...
     * Gets candidate
     *
     * @return \App\Module\RecruitisApi\Model\CommentsGet200ResponsePayloadInnerCandidate|null
     */
     ...
     * Sets candidate
     *
     * @param \App\Module\RecruitisApi\Model\CommentsGet200ResponsePayloadInnerCandidate|null $candidate candidate
     *
     * @return self
     */
    ...
    {
        return $this->container['has_feedback'];
    }

    /**
     * Sets has_feedback
     *
     * @param bool|null $has_feedback has_feedback
     *
     * @return self
     */
    public function setHasFeedback($has_feedback)
    {
        if (is_null($has_feedback)) {
            throw new \InvalidArgumentException('non-nullable has_feedback cannot be null');
        }
        $this->container['has_feedback'] = $has_feedback;
     ...
     * Sets author_avatar
     *
     * @param string|null $author_avatar author_avatar
     *
     * @return self
     */
    public function setAuthorAvatar($author_avatar)
    {
        if (is_null($author_avatar)) {
            throw new \InvalidArgumentException('non-nullable author_avatar cannot be null');
        }
     ...
     *
     * @param string|null $author_initials author_initials
     *
     * @return self
     */
    public function setAuthorInitials($author_initials)
    {
        if (is_null($author_initials)) {
            throw new \InvalidArgumentException('non-nullable author_initials cannot be null');
        }
    ...
    {
        return $this->container['date_edited'];
    }

    /**
     * Sets date_edited
     *
     * @param \DateTime|null $date_edited date_edited
     *
     * @return self
     */
    public function setDateEdited($date_edited)
    {
        if (is_null($date_edited)) {
            throw new \InvalidArgumentException('non-nullable date_edited cannot be null');
        }
        $this->container['date_edited'] = $date_edited;
     ...
     * Gets tags
     *
     * @return \App\Module\RecruitisApi\Model\CommentsGet200ResponsePayloadInnerTagsInner[]|null
     */
     ...
     * Sets tags
     *
     * @param \App\Module\RecruitisApi\Model\CommentsGet200ResponsePayloadInnerTagsInner[]|null $tags tags
     *
     * @return self
     */
