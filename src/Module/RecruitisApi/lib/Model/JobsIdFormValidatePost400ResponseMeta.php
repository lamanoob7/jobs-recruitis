<?php
/**
 * JobsIdFormValidatePost400ResponseMeta
 *
 * PHP version 7.4
 *
 * @category Class
...
/**
 * JobsIdFormValidatePost400ResponseMeta Class Doc Comment
 *
 * @category Class
 * @package  App\Module\RecruitisApi
 * @author   OpenAPI Generator team
 ...
 */
class JobsIdFormValidatePost400ResponseMeta implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = '_jobs__id__form_validate_post_400_response_meta';
    ...
    protected static $openAPITypes = [
        ...
        'code' => 'string',
        'message' => 'string',
        'additional_output' => '\App\Module\RecruitisApi\Model\JobsIdFormValidatePost400ResponseMetaAdditionalOutputInner[]'
    ];
    ...
    protected static $setters = [
        ...
        'code' => 'setCode',
        'message' => 'setMessage',
        'additional_output' => 'setAdditionalOutput'
    ];
    ...
    protected static $getters = [
        ...
        'code' => 'getCode',
        'message' => 'getMessage',
        'additional_output' => 'getAdditionalOutput'
    ];
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('additional_output', $data ?? [], null);
    }
    ...
    */
    ...
    /**
     * Gets additional_output
     *
     * @return \App\Module\RecruitisApi\Model\JobsIdFormValidatePost400ResponseMetaAdditionalOutputInner[]|null
     */
    public function getAdditionalOutput()
    {
        return $this->container['additional_output'];
    }

    /**
     * Sets additional_output
     *
     * @param \App\Module\RecruitisApi\Model\JobsIdFormValidatePost400ResponseMetaAdditionalOutputInner[]|null $additional_output additional_output
     *
     * @return self
     */
    public function setAdditionalOutput($additional_output)
    {
        if (is_null($additional_output)) {
            throw new \InvalidArgumentException('non-nullable additional_output cannot be null');
        }
        $this->container['additional_output'] = $additional_output;
