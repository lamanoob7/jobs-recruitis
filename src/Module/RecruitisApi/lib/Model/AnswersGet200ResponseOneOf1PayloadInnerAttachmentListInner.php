<?php
/**
 * AnswersGet200ResponseOneOf1PayloadInnerAttachmentListInner
 *
 * PHP version 7.4
 *
 * @category Class
...
/**
 * AnswersGet200ResponseOneOf1PayloadInnerAttachmentListInner Class Doc Comment
 *
 * @category Class
 * @package  App\Module\RecruitisApi
 * @author   OpenAPI Generator team
 ...
 */
class AnswersGet200ResponseOneOf1PayloadInnerAttachmentListInner implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = '_answers_get_200_response_oneOf_1_payload_inner_attachment_list_inner';
    ...
    */
     ...
     * Sets name
     *
     * @param string|null $name Název souboru.
     *
     * @return self
     */
     ...
     * Sets size
     *
     * @param float|null $size Velikost souboru.
     *
     * @return self
     */
     ...
     * Sets hash
     *
     * @param string|null $hash ID (hash) souboru.
     *
     * @return self
     */
     ...
     * Sets download_url
     *
     * @param string|null $download_url REST API url adresa na stáhnutí souboru. Při volání musíte být autorizováni full_access tokenem. Viz files sekce.
     *
     * @return self
     */
