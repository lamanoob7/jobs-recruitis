<?php
/**
 * CalendarInterviewsAnswerIdGet200ResponseMeta
 *
 * PHP version 7.4
 *
 * @category Class
...
/**
 * CalendarInterviewsAnswerIdGet200ResponseMeta Class Doc Comment
 *
 * @category Class
 * @package  App\Module\RecruitisApi
 * @author   OpenAPI Generator team
 ...
 */
class CalendarInterviewsAnswerIdGet200ResponseMeta implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = '_calendar_interviews__answer_id__get_200_response_meta';
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('entries_page', $data ?? [], null);
    }
    ...
    */
     ...
     * @return int|null
     */
    public function getEntriesPage()
    {
        return $this->container['entries_page'];
    }

    /**
     * Sets entries_page
     *
     * @param int|null $entries_page entries_page
     *
     * @return self
     */
    public function setEntriesPage($entries_page)
    {
        if (is_null($entries_page)) {
            throw new \InvalidArgumentException('non-nullable entries_page cannot be null');
        }
        $this->container['entries_page'] = $entries_page;
