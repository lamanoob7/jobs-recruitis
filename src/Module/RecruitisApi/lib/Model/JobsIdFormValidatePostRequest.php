...
/**
 * JobsIdFormValidatePostRequest Class Doc Comment
 *
 * @category Class
 * @package  App\Module\RecruitisApi
 * @author   OpenAPI Generator team
 ...
 */
class JobsIdFormValidatePostRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = '_jobs__id__form_validate_post_request';
    ...
    protected static $openAPITypes = [
        ...
        'source_id' => 'int',
        'linkedin' => 'string',
        'cv' => '\App\Module\RecruitisApi\Model\JobsIdFormValidatePostRequestCvInner[]',
        'gdpr_34' => 'bool',
        'salary' => 'int'
    ];
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('referral_id', $data ?? [], null);
        $this->setIfExists('source_id', $data ?? [], null);
        $this->setIfExists('linkedin', $data ?? [], null);
        $this->setIfExists('cv', $data ?? [], null);
        $this->setIfExists('gdpr_34', $data ?? [], null);
    ...
    */
     ...
     * Sets referral_id
     *
     * @param string|null $referral_id referral_id
     *
     * @return self
     */
    public function setReferralId($referral_id)
    {
        if (is_null($referral_id)) {
            throw new \InvalidArgumentException('non-nullable referral_id cannot be null');
        }
     ...
     * Gets cv
     *
     * @return \App\Module\RecruitisApi\Model\JobsIdFormValidatePostRequestCvInner[]|null
     */
     ...
     * Sets cv
     *
     * @param \App\Module\RecruitisApi\Model\JobsIdFormValidatePostRequestCvInner[]|null $cv cv
     *
     * @return self
     */
     ...
     * @return bool|null
     */
    public function getGdpr34()
    {
        return $this->container['gdpr_34'];
    }

    /**
     * Sets gdpr_34
     *
     * @param bool|null $gdpr_34 Zde se jedná o vlastní gdpr_agreement. ID (číslo za \"_\") se může lišit.
     *
     * @return self
     */
    public function setGdpr34($gdpr_34)
    {
        if (is_null($gdpr_34)) {
            throw new \InvalidArgumentException('non-nullable gdpr_34 cannot be null');
        }
        $this->container['gdpr_34'] = $gdpr_34;
