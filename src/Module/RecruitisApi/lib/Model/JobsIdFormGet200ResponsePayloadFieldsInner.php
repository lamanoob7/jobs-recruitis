...
/**
 * JobsIdFormGet200ResponsePayloadFieldsInner Class Doc Comment
 *
 * @category Class
 * @package  App\Module\RecruitisApi
 * @author   OpenAPI Generator team
 ...
 */
class JobsIdFormGet200ResponsePayloadFieldsInner implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = '_jobs__id__form_get_200_response_payload_fields_inner';
    ...
    public const TYPE_SELECTM = 'select:m';
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('input_options', $data ?? [], null);
    ...
    */
     ...
     * Sets name
     *
     * @param string|null $name Hodnota HTML atributu \"name\".
     *
     * @return self
     */
     ...
     * Sets type
     *
     * @param string|null $type Hodnota HTML atributu \"type\". V případě hodnoty \"select\" se jedná o selectbox, v případě \"select:m\" se jedná o multichoice selectbox. V případě hodnoty \"textarea\" se jedná o textové pole. Email a URL jsou HTML5 inputy, které umožňují vestavěnou validaci, jinak lze nahradit za \"text\".
     *
     * @return self
     */
     ...
     * Sets label
     *
     * @param string|null $label Label HTML inputu.
     *
     * @return self
     */
     ...
     * Sets value
     *
     * @param string|null $value Defaultní hodnota inputu. Vždy jako jedna hodnota, i v případě multichoice selectu.
     *
     * @return self
     */
     ...
     * Sets input_options
     *
     * @param object|null $input_options Dodatečné HTML atributy inputu, můžou být přednastavené data atributy. Multidimenzionální pole/objekt. Např. [data => [cf => date]] je třeba transformovat na data-cf=date.
     *
     * @return self
     */
    public function setInputOptions($input_options)
    {
        if (is_null($input_options)) {
            array_push($this->openAPINullablesSetToNull, 'input_options');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('input_options', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
     ...
     * Sets required
     *
     * @param bool|null $required Udává, zda je input povinný.
     *
     * @return self
     */
     ...
     * Sets hidden
     *
     * @param bool|null $hidden Udává, zda má být prvek skrytý.
     *
     * @return self
     */
     ...
     * Sets options
     *
     * @param object|null $options Objekt s hodnotami pro selectbox, tj. jednotlivé options. Ve formátu label => value.
     *
     * @return self
     */
     ...
     * Sets order
     *
     * @param int|null $order Pořadí inputu ve formuláři.
     *
     * @return self
     */
