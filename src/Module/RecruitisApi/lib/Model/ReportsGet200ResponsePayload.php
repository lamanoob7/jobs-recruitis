...
/**
 * ReportsGet200ResponsePayload Class Doc Comment
 *
 * @category Class
 * @package  App\Module\RecruitisApi
 * @author   OpenAPI Generator team
 ...
 */
class ReportsGet200ResponsePayload implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = '_reports_get_200_response_payload';
    ...
    protected static $openAPITypes = [
        'answers' => '\App\Module\RecruitisApi\Model\ReportsGet200ResponsePayloadAnswersInner[]',
        'jobs' => '\App\Module\RecruitisApi\Model\ReportsGet200ResponsePayloadJobsInner[]',
        'offices' => '\App\Module\RecruitisApi\Model\ReportsGet200ResponsePayloadOfficesInner[]',
        'personalists_answers' => '\App\Module\RecruitisApi\Model\ReportsGet200ResponsePayloadPersonalistsAnswersInner[]',
        'personalists_timeline' => '\App\Module\RecruitisApi\Model\ReportsGet200ResponsePayloadPersonalistsTimelineInner[]',
        'personalists' => '\App\Module\RecruitisApi\Model\ReportsGet200ResponsePayloadPersonalistsInner[]',
        'timeline' => '\App\Module\RecruitisApi\Model\ReportsGet200ResponsePayloadTimelineInner[]',
        'custom_fields' => '\App\Module\RecruitisApi\Model\ReportsGet200ResponsePayloadCustomFieldsInner[]'
    ];
    ...
    protected static $openAPIFormats = [
        ...
        'jobs' => null,
        'offices' => null,
        'personalists_answers' => null,
        'personalists_timeline' => null,
        'personalists' => null,
        'timeline' => null,
        'custom_fields' => null
    ];
    ...
    protected static array $openAPINullables = [
        ...
        'jobs' => false,
        'offices' => false,
        'personalists_answers' => false,
        'personalists_timeline' => false,
        'personalists' => false,
        'timeline' => false,
        'custom_fields' => false
    ];
    ...
    protected static $attributeMap = [
        ...
        'jobs' => 'jobs',
        'offices' => 'offices',
        'personalists_answers' => 'personalists-answers',
        'personalists_timeline' => 'personalists-timeline',
        'personalists' => 'personalists',
        'timeline' => 'timeline',
    ...
    protected static $setters = [
        ...
        'jobs' => 'setJobs',
        'offices' => 'setOffices',
        'personalists_answers' => 'setPersonalistsAnswers',
        'personalists_timeline' => 'setPersonalistsTimeline',
        'personalists' => 'setPersonalists',
    ...
    protected static $getters = [
        ...
        'jobs' => 'getJobs',
        'offices' => 'getOffices',
        'personalists_answers' => 'getPersonalistsAnswers',
        'personalists_timeline' => 'getPersonalistsTimeline',
        'personalists' => 'getPersonalists',
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('personalists_answers', $data ?? [], null);
        $this->setIfExists('personalists_timeline', $data ?? [], null);
        $this->setIfExists('personalists', $data ?? [], null);
    ...
    */
     ...
     * Gets answers
     *
     * @return \App\Module\RecruitisApi\Model\ReportsGet200ResponsePayloadAnswersInner[]|null
     */
     ...
     * Sets answers
     *
     * @param \App\Module\RecruitisApi\Model\ReportsGet200ResponsePayloadAnswersInner[]|null $answers answers
     *
     * @return self
     */
     ...
     * Gets jobs
     *
     * @return \App\Module\RecruitisApi\Model\ReportsGet200ResponsePayloadJobsInner[]|null
     */
     ...
     * Sets jobs
     *
     * @param \App\Module\RecruitisApi\Model\ReportsGet200ResponsePayloadJobsInner[]|null $jobs jobs
     *
     * @return self
     */
     ...
     * Gets offices
     *
     * @return \App\Module\RecruitisApi\Model\ReportsGet200ResponsePayloadOfficesInner[]|null
     */
     ...
     * Sets offices
     *
     * @param \App\Module\RecruitisApi\Model\ReportsGet200ResponsePayloadOfficesInner[]|null $offices offices
     *
     * @return self
     */
    ...
    /**
     * Gets personalists_answers
     *
     * @return \App\Module\RecruitisApi\Model\ReportsGet200ResponsePayloadPersonalistsAnswersInner[]|null
     */
    public function getPersonalistsAnswers()
    {
        return $this->container['personalists_answers'];
    }

    /**
     * Sets personalists_answers
     *
     * @param \App\Module\RecruitisApi\Model\ReportsGet200ResponsePayloadPersonalistsAnswersInner[]|null $personalists_answers personalists_answers
     *
     * @return self
     */
    public function setPersonalistsAnswers($personalists_answers)
    {
        if (is_null($personalists_answers)) {
            throw new \InvalidArgumentException('non-nullable personalists_answers cannot be null');
        }
        $this->container['personalists_answers'] = $personalists_answers;

        return $this;
    }

    /**
     * Gets personalists_timeline
     *
     * @return \App\Module\RecruitisApi\Model\ReportsGet200ResponsePayloadPersonalistsTimelineInner[]|null
     */
    public function getPersonalistsTimeline()
    {
        return $this->container['personalists_timeline'];
    }

    /**
     * Sets personalists_timeline
     *
     * @param \App\Module\RecruitisApi\Model\ReportsGet200ResponsePayloadPersonalistsTimelineInner[]|null $personalists_timeline personalists_timeline
     *
     * @return self
     */
    public function setPersonalistsTimeline($personalists_timeline)
    {
        if (is_null($personalists_timeline)) {
            throw new \InvalidArgumentException('non-nullable personalists_timeline cannot be null');
        }
        $this->container['personalists_timeline'] = $personalists_timeline;
     ...
     * Gets personalists
     *
     * @return \App\Module\RecruitisApi\Model\ReportsGet200ResponsePayloadPersonalistsInner[]|null
     */
    public function getPersonalists()
    {
        return $this->container['personalists'];
    }

    /**
     * Sets personalists
     *
     * @param \App\Module\RecruitisApi\Model\ReportsGet200ResponsePayloadPersonalistsInner[]|null $personalists personalists
     *
     * @return self
     */
    public function setPersonalists($personalists)
    {
        if (is_null($personalists)) {
            throw new \InvalidArgumentException('non-nullable personalists cannot be null');
        }
        $this->container['personalists'] = $personalists;
     ...
     * Gets timeline
     *
     * @return \App\Module\RecruitisApi\Model\ReportsGet200ResponsePayloadTimelineInner[]|null
     */
     ...
     * Sets timeline
     *
     * @param \App\Module\RecruitisApi\Model\ReportsGet200ResponsePayloadTimelineInner[]|null $timeline timeline
     *
     * @return self
     */
     ...
     * Gets custom_fields
     *
     * @return \App\Module\RecruitisApi\Model\ReportsGet200ResponsePayloadCustomFieldsInner[]|null
     */
     ...
     * Sets custom_fields
     *
     * @param \App\Module\RecruitisApi\Model\ReportsGet200ResponsePayloadCustomFieldsInner[]|null $custom_fields custom_fields
     *
     * @return self
     */
