...
class Automation implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        'id' => 'int',
        'event_name' => 'string',
        'event_params' => '\App\Module\RecruitisApi\Model\AutomationEventParams',
        'pipeline' => '\App\Module\RecruitisApi\Model\AutomationPipelineInnerInner[][]',
        'stopped' => 'bool',
        'author_id' => 'int',
        'created_at' => 'string',
        'updated_at' => 'string'
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('event_params', $data ?? [], null);
    ...
    */
     ...
     * Gets event_params
     *
     * @return \App\Module\RecruitisApi\Model\AutomationEventParams|null
     */
     ...
     * Sets event_params
     *
     * @param \App\Module\RecruitisApi\Model\AutomationEventParams|null $event_params event_params
     *
     * @return self
     */
    public function setEventParams($event_params)
    {
        if (is_null($event_params)) {
            throw new \InvalidArgumentException('non-nullable event_params cannot be null');
        }
     ...
     * Gets pipeline
     *
     * @return \App\Module\RecruitisApi\Model\AutomationPipelineInnerInner[][]|null
     */
     ...
     * Sets pipeline
     *
     * @param \App\Module\RecruitisApi\Model\AutomationPipelineInnerInner[][]|null $pipeline pipeline
     *
     * @return self
     */
