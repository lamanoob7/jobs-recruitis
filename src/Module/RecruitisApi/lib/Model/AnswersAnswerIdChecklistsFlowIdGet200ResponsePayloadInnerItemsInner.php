<?php
/**
 * AnswersAnswerIdChecklistsFlowIdGet200ResponsePayloadInnerItemsInner
 *
 * PHP version 7.4
 *
 * @category Class
...
/**
 * AnswersAnswerIdChecklistsFlowIdGet200ResponsePayloadInnerItemsInner Class Doc Comment
 *
 * @category Class
 * @package  App\Module\RecruitisApi
 * @author   OpenAPI Generator team
 ...
 */
class AnswersAnswerIdChecklistsFlowIdGet200ResponsePayloadInnerItemsInner implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = '_answers__answer_id__checklists__flow_id__get_200_response_payload_inner_items_inner';
    ...
    protected static $attributeMap = [
        'id' => 'id',
        'title_recruiter' => 'title_recruiter',
    ...
    protected static $setters = [
        'id' => 'setId',
        'title_recruiter' => 'setTitleRecruiter',
        'title_candidate' => 'setTitleCandidate',
        'sort' => 'setSort',
        'text' => 'setText',
        'state' => 'setState',
    ...
    protected static $getters = [
        'id' => 'getId',
        'title_recruiter' => 'getTitleRecruiter',
        'title_candidate' => 'getTitleCandidate',
        'sort' => 'getSort',
        'text' => 'getText',
        'state' => 'getState',
        'flow_state' => 'getFlowState',
        'author' => 'getAuthor',
        'date' => 'getDate'
    ];
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('title_recruiter', $data ?? [], null);
        $this->setIfExists('title_candidate', $data ?? [], null);
        $this->setIfExists('sort', $data ?? [], null);
        $this->setIfExists('text', $data ?? [], null);
        $this->setIfExists('state', $data ?? [], null);
        $this->setIfExists('flow_state', $data ?? [], null);
    ...
    */
    ...
    /**
     * Gets title_recruiter
     *
     * @return string|null
     */
    public function getTitleRecruiter()
    {
        return $this->container['title_recruiter'];
    }

    /**
     * Sets title_recruiter
     *
     * @param string|null $title_recruiter title_recruiter
     *
     * @return self
     */
    public function setTitleRecruiter($title_recruiter)
    {
        if (is_null($title_recruiter)) {
            throw new \InvalidArgumentException('non-nullable title_recruiter cannot be null');
        }
        $this->container['title_recruiter'] = $title_recruiter;

        return $this;
    }

    /**
     * Gets title_candidate
     *
     * @return string|null
     */
    public function getTitleCandidate()
    {
        return $this->container['title_candidate'];
    }

    /**
     * Sets title_candidate
     *
     * @param string|null $title_candidate title_candidate
     *
     * @return self
     */
    public function setTitleCandidate($title_candidate)
    {
        if (is_null($title_candidate)) {
            throw new \InvalidArgumentException('non-nullable title_candidate cannot be null');
        }
        $this->container['title_candidate'] = $title_candidate;
    ...
    {
        return $this->container['flow_state'];
    }

    /**
     * Sets flow_state
     *
     * @param int|null $flow_state flow_state
     *
     * @return self
     */
    public function setFlowState($flow_state)
    {
        if (is_null($flow_state)) {
            throw new \InvalidArgumentException('non-nullable flow_state cannot be null');
        }
        $this->container['flow_state'] = $flow_state;
