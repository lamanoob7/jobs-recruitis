<?php
/**
 * CalendarReservationLinksPost201ResponsePayload
 *
 * PHP version 7.4
 *
 * @category Class
...
/**
 * CalendarReservationLinksPost201ResponsePayload Class Doc Comment
 *
 * @category Class
 * @package  App\Module\RecruitisApi
 * @author   OpenAPI Generator team
 ...
 */
class CalendarReservationLinksPost201ResponsePayload implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = '_calendar_reservation_links_post_201_response_payload';
    ...
    protected static $openAPITypes = [
        'event' => 'string',
        'reservation_link' => '\App\Module\RecruitisApi\Model\CalendarReservationLinksPost201ResponsePayloadReservationLink'
    ];
    ...
    */
     ...
     *
     * @return \App\Module\RecruitisApi\Model\CalendarReservationLinksPost201ResponsePayloadReservationLink|null
     */
     ...
     *
     * @param \App\Module\RecruitisApi\Model\CalendarReservationLinksPost201ResponsePayloadReservationLink|null $reservation_link reservation_link
     *
     * @return self
     */
    public function setReservationLink($reservation_link)
    {
        if (is_null($reservation_link)) {
            throw new \InvalidArgumentException('non-nullable reservation_link cannot be null');
        }
