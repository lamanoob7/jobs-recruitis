...
/**
 * FiltersPostRequest Class Doc Comment
 *
 * @category Class
 * @package  App\Module\RecruitisApi
 * @author   OpenAPI Generator team
 ...
 */
class FiltersPostRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = '_filters_post_request';
    ...
    */
     ...
     * Sets group
     *
     * @param string $group Název skupiny, do které se filtr automaticky zařadí.
     *
     * @return self
     */
