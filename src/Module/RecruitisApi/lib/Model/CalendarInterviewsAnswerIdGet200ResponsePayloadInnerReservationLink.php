<?php
/**
 * CalendarInterviewsAnswerIdGet200ResponsePayloadInnerReservationLink
 *
 * PHP version 7.4
 *
 * @category Class
...
/**
 * CalendarInterviewsAnswerIdGet200ResponsePayloadInnerReservationLink Class Doc Comment
 *
 * @category Class
 * @package  App\Module\RecruitisApi
 * @author   OpenAPI Generator team
 ...
 */
class CalendarInterviewsAnswerIdGet200ResponsePayloadInnerReservationLink implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = '_calendar_interviews__answer_id__get_200_response_payload_inner_reservation_link';
    ...
    protected static $attributeMap = [
        'id' => 'id',
        'reservation_link_id' => 'reservation_link_id',
        'url' => 'url'
    ];
    ...
    protected static $setters = [
        'id' => 'setId',
        'reservation_link_id' => 'setReservationLinkId',
        'url' => 'setUrl'
    ];
    ...
    protected static $getters = [
        'id' => 'getId',
        'reservation_link_id' => 'getReservationLinkId',
        'url' => 'getUrl'
    ];
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('reservation_link_id', $data ?? [], null);
    ...
    */
    ...
    /**
     * Gets reservation_link_id
     *
     * @return int|null
     */
    public function getReservationLinkId()
    {
        return $this->container['reservation_link_id'];
    }

    /**
     * Sets reservation_link_id
     *
     * @param int|null $reservation_link_id reservation_link_id
     *
     * @return self
     */
    public function setReservationLinkId($reservation_link_id)
    {
        if (is_null($reservation_link_id)) {
            throw new \InvalidArgumentException('non-nullable reservation_link_id cannot be null');
        }
        $this->container['reservation_link_id'] = $reservation_link_id;
