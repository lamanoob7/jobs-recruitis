...
/**
 * ReferralsPostRequest Class Doc Comment
 *
 * @category Class
 * @package  App\Module\RecruitisApi
 * @author   OpenAPI Generator team
 ...
 */
class ReferralsPostRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = '_referrals_post_request';
    ...
    */
     ...
     * Sets name
     *
     * @param string $name Jméno referrala.
     *
     * @return self
     */
     ...
     * Sets phone
     *
     * @param string|null $phone Telefon referrala.
     *
     * @return self
     */
     ...
     * Sets email_text
     *
     * @param string|null $email_text Pokud je zadáno, pak se tento email rovnou při vytvoření referrala pošle na určený email. Podporuje i proměnné, viz emailové šablony v Recruitisu.
     *
     * @return self
     */
