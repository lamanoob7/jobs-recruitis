...
/**
 * ExtraInnerAnyOf2 Class Doc Comment
 *
 * @category Class
 * @package  App\Module\RecruitisApi
 * @author   OpenAPI Generator team
 ...
 */
class ExtraInnerAnyOf2 implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'Extra_inner_anyOf_2';
    ...
    */
    ...
    public function setAnswerTag($answer_tag)
    {
        ...
        if ((mb_strlen($answer_tag) > 100)) {
            throw new \InvalidArgumentException('invalid length for $answer_tag when calling ExtraInnerAnyOf2., must be smaller than or equal to 100.');
        }
