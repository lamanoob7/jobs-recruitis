 ...
 */
class JobChannels implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'Job_channels';
    ...
    protected static $openAPITypes = [
        'portal' => '\App\Module\RecruitisApi\Model\JobChannelsPortal',
        'company_page' => '\App\Module\RecruitisApi\Model\JobChannelsPortal',
        'intranet' => '\App\Module\RecruitisApi\Model\JobChannelsPortal',
        'internal' => '\App\Module\RecruitisApi\Model\JobChannelsPortal',
        'czechcrunch' => '\App\Module\RecruitisApi\Model\JobChannelsPortal',
        'profesia' => '\App\Module\RecruitisApi\Model\JobChannelsPortal',
        'facebook' => '\App\Module\RecruitisApi\Model\JobChannelsPortal'
    ];
    ...
    protected static $setters = [
        'portal' => 'setPortal',
        'company_page' => 'setCompanyPage',
        'intranet' => 'setIntranet',
        'internal' => 'setInternal',
        'czechcrunch' => 'setCzechcrunch',
        'profesia' => 'setProfesia',
    ...
    protected static $getters = [
        'portal' => 'getPortal',
        'company_page' => 'getCompanyPage',
        'intranet' => 'getIntranet',
        'internal' => 'getInternal',
        'czechcrunch' => 'getCzechcrunch',
        'profesia' => 'getProfesia',
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('company_page', $data ?? [], null);
        $this->setIfExists('intranet', $data ?? [], null);
        $this->setIfExists('internal', $data ?? [], null);
        $this->setIfExists('czechcrunch', $data ?? [], null);
        $this->setIfExists('profesia', $data ?? [], null);
    ...
    */
     ...
     * Gets portal
     *
     * @return \App\Module\RecruitisApi\Model\JobChannelsPortal|null
     */
     ...
     * Sets portal
     *
     * @param \App\Module\RecruitisApi\Model\JobChannelsPortal|null $portal portal
     *
     * @return self
     */
    ...
    {
        return $this->container['company_page'];
    }

    /**
     * Sets company_page
     *
     * @param \App\Module\RecruitisApi\Model\JobChannelsPortal|null $company_page company_page
     *
     * @return self
     */
    public function setCompanyPage($company_page)
    {
        if (is_null($company_page)) {
            throw new \InvalidArgumentException('non-nullable company_page cannot be null');
        }
        $this->container['company_page'] = $company_page;
    ...
    {
        return $this->container['intranet'];
    }

    /**
     * Sets intranet
     *
     * @param \App\Module\RecruitisApi\Model\JobChannelsPortal|null $intranet intranet
     *
     * @return self
     */
    ...
    {
        if (is_null($intranet)) {
            throw new \InvalidArgumentException('non-nullable intranet cannot be null');
        }
        $this->container['intranet'] = $intranet;
     ...
     * Sets internal
     *
     * @param \App\Module\RecruitisApi\Model\JobChannelsPortal|null $internal internal
     *
     * @return self
     */
     ...
     * @return \App\Module\RecruitisApi\Model\JobChannelsPortal|null
     */
    public function getCzechcrunch()
    {
        return $this->container['czechcrunch'];
    }

    /**
     * Sets czechcrunch
     *
     * @param \App\Module\RecruitisApi\Model\JobChannelsPortal|null $czechcrunch czechcrunch
     *
     * @return self
     */
    public function setCzechcrunch($czechcrunch)
    {
        if (is_null($czechcrunch)) {
            throw new \InvalidArgumentException('non-nullable czechcrunch cannot be null');
        }
        $this->container['czechcrunch'] = $czechcrunch;
     ...
     * @return \App\Module\RecruitisApi\Model\JobChannelsPortal|null
     */
    public function getProfesia()
    {
        return $this->container['profesia'];
    }

    /**
     * Sets profesia
     *
     * @param \App\Module\RecruitisApi\Model\JobChannelsPortal|null $profesia profesia
     *
     * @return self
     */
    public function setProfesia($profesia)
    {
        if (is_null($profesia)) {
            throw new \InvalidArgumentException('non-nullable profesia cannot be null');
        }
        $this->container['profesia'] = $profesia;
     ...
     * Sets facebook
     *
     * @param \App\Module\RecruitisApi\Model\JobChannelsPortal|null $facebook facebook
     *
     * @return self
     */
