...
/**
 * CommentsPutRequest Class Doc Comment
 *
 * @category Class
 * @package  App\Module\RecruitisApi
 * @author   OpenAPI Generator team
 ...
 */
class CommentsPutRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = '_comments_put_request';
    ...
    public const FIELD_APPLICANT = 'applicant';
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['argument'] === null) {
            $invalidProperties[] = "'argument' can't be null";
        }
