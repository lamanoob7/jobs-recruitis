...
/**
 * CandidatesPostRequest Class Doc Comment
 *
 * @category Class
 * @package  App\Module\RecruitisApi
 * @author   OpenAPI Generator team
 ...
 */
class CandidatesPostRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = '_candidates_post_request';
    ...
    protected static $openAPITypes = [
        ...
        'strict' => 'bool',
        'im_author' => 'bool',
        'gdpr_agreement' => '\App\Module\RecruitisApi\Model\GDPR',
        'extra' => '\App\Module\RecruitisApi\Model\ExtraInner[]',
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('im_author', $data ?? [], false);
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['gdpr_agreement'] === null) {
            $invalidProperties[] = "'gdpr_agreement' can't be null";
        }
     ...
     * Sets strict
     *
     * @param bool|null $strict Pokud je uvedena hodnotou '1', poté se při nezdaru nahrávání přílohy zastaví celý proces a vrátí se chyba.     V opačném případě se uchazeč nahraje s informací,     že ne všechno se nahrálo správně (viz [Meta - additional output](#meta-informace----additional_output)).
     *
     * @return self
     */
     ...
     * @return bool|null
     */
    public function getImAuthor()
    {
        return $this->container['im_author'];
    }

    /**
     * Sets im_author
     *
     * @param bool|null $im_author Pokud je true, potom je daný personalista určen jako autor odpovědi, včetně poznámek. V opačném případě nebudou mít poznámky žádného autora a budou tzv. systémové.
     *
     * @return self
     */
    public function setImAuthor($im_author)
    {
        if (is_null($im_author)) {
            throw new \InvalidArgumentException('non-nullable im_author cannot be null');
        }
        $this->container['im_author'] = $im_author;
     ...
     * Gets gdpr_agreement
     *
     * @return \App\Module\RecruitisApi\Model\GDPR
     */
     ...
     * Sets gdpr_agreement
     *
     * @param \App\Module\RecruitisApi\Model\GDPR $gdpr_agreement gdpr_agreement
     *
     * @return self
     */
     ...
     * Gets extra
     *
     * @return \App\Module\RecruitisApi\Model\ExtraInner[]|null
     */
     ...
     * Sets extra
     *
     * @param \App\Module\RecruitisApi\Model\ExtraInner[]|null $extra Pole objektů, které přiřadí k odpovědi poznámku nebo tag.
     *
     * @return self
     */
