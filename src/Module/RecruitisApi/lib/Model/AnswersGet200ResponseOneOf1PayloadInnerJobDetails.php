<?php
/**
 * AnswersGet200ResponseOneOf1PayloadInnerJobDetails
 *
 * PHP version 7.4
 *
 * @category Class
...
/**
 * AnswersGet200ResponseOneOf1PayloadInnerJobDetails Class Doc Comment
 *
 * @category Class
 * @package  App\Module\RecruitisApi
 * @author   OpenAPI Generator team
 ...
 */
class AnswersGet200ResponseOneOf1PayloadInnerJobDetails implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = '_answers_get_200_response_oneOf_1_payload_inner_job_details';
    ...
    protected static array $openAPINullables = [
        'job_title' => false,
        'job_id' => false,
        'job_detail_url' => false,
        'job_contact_name' => false,
        'job_contact_email' => false,
        'job_contact_phone' => false
    ];
    ...
    protected static $setters = [
        ...
        'job_id' => 'setJobId',
        'job_detail_url' => 'setJobDetailUrl',
        'job_contact_name' => 'setJobContactName',
        'job_contact_email' => 'setJobContactEmail',
        'job_contact_phone' => 'setJobContactPhone'
    ];
    ...
    protected static $getters = [
        ...
        'job_id' => 'getJobId',
        'job_detail_url' => 'getJobDetailUrl',
        'job_contact_name' => 'getJobContactName',
        'job_contact_email' => 'getJobContactEmail',
        'job_contact_phone' => 'getJobContactPhone'
    ];
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('job_detail_url', $data ?? [], null);
        $this->setIfExists('job_contact_name', $data ?? [], null);
        $this->setIfExists('job_contact_email', $data ?? [], null);
        $this->setIfExists('job_contact_phone', $data ?? [], null);
    }
    ...
    */
     ...
     * Sets job_title
     *
     * @param string|null $job_title Název inzerátu, ke kterému je odpověď přiřazena.
     *
     * @return self
     */
     ...
     * Sets job_id
     *
     * @param int|null $job_id ID inzerátu, ke kterému se odpověď vztahuje.
     *
     * @return self
     */
     ...
     * @return string|null
     */
    public function getJobDetailUrl()
    {
        return $this->container['job_detail_url'];
    }

    /**
     * Sets job_detail_url
     *
     * @param string|null $job_detail_url Url adresa inzerátu.
     *
     * @return self
     */
    public function setJobDetailUrl($job_detail_url)
    {
        if (is_null($job_detail_url)) {
            throw new \InvalidArgumentException('non-nullable job_detail_url cannot be null');
        }
        $this->container['job_detail_url'] = $job_detail_url;

        return $this;
    }

    /**
     * Gets job_contact_name
     *
     * @return string|null
     */
    public function getJobContactName()
    {
        return $this->container['job_contact_name'];
    }

    /**
     * Sets job_contact_name
     *
     * @param string|null $job_contact_name Jméno kontaktní osoby, přidružené k inzerátu.
     *
     * @return self
     */
    public function setJobContactName($job_contact_name)
    {
        if (is_null($job_contact_name)) {
            throw new \InvalidArgumentException('non-nullable job_contact_name cannot be null');
        }
        $this->container['job_contact_name'] = $job_contact_name;

        return $this;
    }

    /**
     * Gets job_contact_email
     *
     * @return string|null
     */
    public function getJobContactEmail()
    {
        return $this->container['job_contact_email'];
    }

    /**
     * Sets job_contact_email
     *
     * @param string|null $job_contact_email Email kontaktní osoby.
     *
     * @return self
     */
    public function setJobContactEmail($job_contact_email)
    {
        if (is_null($job_contact_email)) {
            throw new \InvalidArgumentException('non-nullable job_contact_email cannot be null');
        }
        $this->container['job_contact_email'] = $job_contact_email;

        return $this;
    }

    /**
     * Gets job_contact_phone
     *
     * @return string|null
     */
    public function getJobContactPhone()
    {
        return $this->container['job_contact_phone'];
    }

    /**
     * Sets job_contact_phone
     *
     * @param string|null $job_contact_phone Telefon kontaktní osoby.
     *
     * @return self
     */
    public function setJobContactPhone($job_contact_phone)
    {
        if (is_null($job_contact_phone)) {
            throw new \InvalidArgumentException('non-nullable job_contact_phone cannot be null');
        }
        $this->container['job_contact_phone'] = $job_contact_phone;
