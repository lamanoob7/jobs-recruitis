<?php
/**
 * AnswersAnswerIdGet200ResponsePayloadRequirements
 *
 * PHP version 7.4
 *
 * @category Class
...
/**
 * AnswersAnswerIdGet200ResponsePayloadRequirements Class Doc Comment
 *
 * @category Class
 * @package  App\Module\RecruitisApi
 * @author   OpenAPI Generator team
 ...
 */
class AnswersAnswerIdGet200ResponsePayloadRequirements implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = '_answers__answer_id__get_200_response_payload_requirements';
    ...
    protected static $openAPITypes = [
        ...
        'salary' => '\App\Module\RecruitisApi\Model\AnswersAnswerIdGet200ResponsePayloadRequirementsSalary'
    ];
    ...
    protected static array $openAPINullables = [
        'date_employment' => false,
        'preffered_location' => false,
        'salary' => false
    ];
    ...
    protected static $setters = [
        'date_employment' => 'setDateEmployment',
        'preffered_location' => 'setPrefferedLocation',
        'salary' => 'setSalary'
    ];
    ...
    protected static $getters = [
        'date_employment' => 'getDateEmployment',
        'preffered_location' => 'getPrefferedLocation',
        'salary' => 'getSalary'
    ];
    ...
    {
        $this->setIfExists('date_employment', $data ?? [], null);
        $this->setIfExists('preffered_location', $data ?? [], null);
    ...
    */
    ...
    /**
     * Gets date_employment
     *
     * @return \DateTime|null
     */
    public function getDateEmployment()
    {
        return $this->container['date_employment'];
    }

    /**
     * Sets date_employment
     *
     * @param \DateTime|null $date_employment date_employment
     *
     * @return self
     */
    public function setDateEmployment($date_employment)
    {
        if (is_null($date_employment)) {
            throw new \InvalidArgumentException('non-nullable date_employment cannot be null');
        }
        $this->container['date_employment'] = $date_employment;

        return $this;
    }

    /**
     * Gets preffered_location
     *
     * @return string|null
     */
    public function getPrefferedLocation()
    {
        return $this->container['preffered_location'];
    }

    /**
     * Sets preffered_location
     *
     * @param string|null $preffered_location preffered_location
     *
     * @return self
     */
    public function setPrefferedLocation($preffered_location)
    {
        if (is_null($preffered_location)) {
            throw new \InvalidArgumentException('non-nullable preffered_location cannot be null');
        }
        $this->container['preffered_location'] = $preffered_location;
     ...
     * Gets salary
     *
     * @return \App\Module\RecruitisApi\Model\AnswersAnswerIdGet200ResponsePayloadRequirementsSalary|null
     */
     ...
     * Sets salary
     *
     * @param \App\Module\RecruitisApi\Model\AnswersAnswerIdGet200ResponsePayloadRequirementsSalary|null $salary salary
     *
     * @return self
     */
