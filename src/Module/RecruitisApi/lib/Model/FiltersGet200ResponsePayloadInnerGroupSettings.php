<?php
/**
 * FiltersGet200ResponsePayloadInnerGroupSettings
 *
 * PHP version 7.4
 *
 * @category Class
...
/**
 * FiltersGet200ResponsePayloadInnerGroupSettings Class Doc Comment
 *
 * @category Class
 * @package  App\Module\RecruitisApi
 * @author   OpenAPI Generator team
 ...
 */
class FiltersGet200ResponsePayloadInnerGroupSettings implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = '_filters_get_200_response_payload_inner_group_settings';
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('is_multiselect', $data ?? [], null);
    }
    ...
    */
     ...
     * Sets is_multiselect
     *
     * @param bool|null $is_multiselect is_multiselect
     *
     * @return self
     */
    public function setIsMultiselect($is_multiselect)
    {
        if (is_null($is_multiselect)) {
            throw new \InvalidArgumentException('non-nullable is_multiselect cannot be null');
        }
