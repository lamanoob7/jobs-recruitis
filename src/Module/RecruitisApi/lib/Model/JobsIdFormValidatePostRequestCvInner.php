<?php
/**
 * JobsIdFormValidatePostRequestCvInner
 *
 * PHP version 7.4
 *
 * @category Class
...
/**
 * JobsIdFormValidatePostRequestCvInner Class Doc Comment
 *
 * @category Class
 * @description Povinné pole je filename, v případě že nepošlete base64 ani path, je třeba tyto doplnit po validaci před odesláním na POST /answers.
 * @package  App\Module\RecruitisApi
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 * @implements \ArrayAccess<string, mixed>
 */
class JobsIdFormValidatePostRequestCvInner implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = '_jobs__id__form_validate_post_request_cv_inner';
    ...
    */
     ...
     * Sets base64
     *
     * @param string|null $base64 Base64 encoded obsah souboru. Pro odlehčení přenosu dat není nutné jej posílat k validaci. V takovém případě je nutné jej přilepit k danému objektu po získání response validace.
     *
     * @return self
     */
     ...
     * Sets path
     *
     * @param string|null $path Veřejná lokace (URL adresa) souboru, odkud si jej může Recruitis stánout. Datová náročnost při validaci je minimální, ale pro tento atribut platí to stejné, co pro base64.
     *
     * @return self
     */
