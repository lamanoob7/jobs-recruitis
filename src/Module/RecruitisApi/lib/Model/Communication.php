...
/**
 * Communication Class Doc Comment
 *
 * @category Class
 * @package  App\Module\RecruitisApi
 * @author   OpenAPI Generator team
 ...
 */
class Communication implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'Communication';
    ...
    protected static $openAPITypes = [
        ...
        'html_preview' => 'string',
        'attachments' => '\App\Module\RecruitisApi\Model\CommunicationAttachmentsInner[]'
    ];
    ...
    protected static $setters = [
        ...
        'recipient_avatar' => 'setRecipientAvatar',
        'type' => 'setType',
        'subject' => 'setSubject',
        'content' => 'setContent',
        'date_created' => 'setDateCreated',
        'date_of_action' => 'setDateOfAction',
        'html_preview' => 'setHtmlPreview',
    ...
    protected static $getters = [
        ...
        'recipient_avatar' => 'getRecipientAvatar',
        'type' => 'getType',
        'subject' => 'getSubject',
        'content' => 'getContent',
        'date_created' => 'getDateCreated',
        'date_of_action' => 'getDateOfAction',
        'html_preview' => 'getHtmlPreview',
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('recipient_avatar', $data ?? [], null);
        $this->setIfExists('type', $data ?? [], null);
        $this->setIfExists('subject', $data ?? [], null);
        $this->setIfExists('content', $data ?? [], null);
        $this->setIfExists('date_created', $data ?? [], null);
        $this->setIfExists('date_of_action', $data ?? [], null);
        $this->setIfExists('html_preview', $data ?? [], null);
    ...
    */
     ...
     * Sets candidate_id
     *
     * @param int|null $candidate_id candidate_id
     *
     * @return self
     */
    ...
    public function setSenderAvatar($sender_avatar)
    {
        if (is_null($sender_avatar)) {
            throw new \InvalidArgumentException('non-nullable sender_avatar cannot be null');
        }
    ...
    /**
     * Gets recipient_avatar
     *
     * @return string|null
     */
    public function getRecipientAvatar()
    {
        return $this->container['recipient_avatar'];
    }

    /**
     * Sets recipient_avatar
     *
     * @param string|null $recipient_avatar recipient_avatar
     *
     * @return self
     */
    public function setRecipientAvatar($recipient_avatar)
    {
        if (is_null($recipient_avatar)) {
            throw new \InvalidArgumentException('non-nullable recipient_avatar cannot be null');
        }
        $this->container['recipient_avatar'] = $recipient_avatar;
    ...
    {
        return $this->container['date_of_action'];
    }

    /**
     * Sets date_of_action
     *
     * @param \DateTime|null $date_of_action date_of_action
     *
     * @return self
     */
    public function setDateOfAction($date_of_action)
    {
        if (is_null($date_of_action)) {
            throw new \InvalidArgumentException('non-nullable date_of_action cannot be null');
        }
        $this->container['date_of_action'] = $date_of_action;
    ...
    {
        return $this->container['html_preview'];
    }

    /**
     * Sets html_preview
     *
     * @param string|null $html_preview html_preview
     *
     * @return self
     */
    public function setHtmlPreview($html_preview)
    {
        if (is_null($html_preview)) {
            throw new \InvalidArgumentException('non-nullable html_preview cannot be null');
        }
        $this->container['html_preview'] = $html_preview;
     ...
     * Gets attachments
     *
     * @return \App\Module\RecruitisApi\Model\CommunicationAttachmentsInner[]|null
     */
     ...
     * Sets attachments
     *
     * @param \App\Module\RecruitisApi\Model\CommunicationAttachmentsInner[]|null $attachments attachments
     *
     * @return self
     */
