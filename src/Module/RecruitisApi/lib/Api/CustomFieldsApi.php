...
class CustomFieldsApi
{
     ...
     * @return \App\Module\RecruitisApi\Model\CustomfieldsUserUserIdGet200Response|\App\Module\RecruitisApi\Model\LoginPut401Response|\App\Module\RecruitisApi\Model\JobsIdGet404Response
     */
     ...
     * @throws \App\Module\RecruitisApi\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \App\Module\RecruitisApi\Model\CustomfieldsUserUserIdGet200Response|\App\Module\RecruitisApi\Model\LoginPut401Response|\App\Module\RecruitisApi\Model\JobsIdGet404Response, HTTP status code, HTTP response headers (array of strings)
     */
    public function customfieldsUserUserIdAnswerIdGetWithHttpInfo($user_id, $answer_id, string $contentType = self::contentTypes['customfieldsUserUserIdAnswerIdGet'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\App\Module\RecruitisApi\Model\CustomfieldsUserUserIdGet200Response' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\App\Module\RecruitisApi\Model\CustomfieldsUserUserIdGet200Response' !== 'string') {
                            try {
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\App\Module\RecruitisApi\Model\CustomfieldsUserUserIdGet200Response', []),
            ...
            $returnType = '\App\Module\RecruitisApi\Model\CustomfieldsUserUserIdGet200Response';
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\App\Module\RecruitisApi\Model\CustomfieldsUserUserIdGet200Response',
