...
class ReportApi
{
     ...
     * Export data
     *
     * @param  int $version Verze reportu, dle číselníku, aktuálně pouze &#39;1&#39;. (required)
     * @param  string[] $lists Filtrace jednotlivých skupin exportů: answers, jobs, offices, personalists-answers, personalists, timeline, custom-fields. V případě, že není určeno, zvolí se všechny skupiny. (optional)
     * @param  \DateTime $date_from Datum, od kdy se mají exportovat data. Pokud nebude vyplněno, použije se aktuální den. (optional)
     * @param  \DateTime $date_to Datum, do kdy se mají exportovat data. Pokud nebude vyplněno, použije se aktuální den. (optional)
     ...
     * @return \App\Module\RecruitisApi\Model\ReportsGet200Response|\App\Module\RecruitisApi\Model\ReportsGet400Response
     */
    public function reportsGet($version, $lists = null, $date_from = null, $date_to = null, string $contentType = self::contentTypes['reportsGet'][0])
    {
        list($response) = $this->reportsGetWithHttpInfo($version, $lists, $date_from, $date_to, $contentType);
        return $response;
    }
     ...
     * @throws \App\Module\RecruitisApi\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \App\Module\RecruitisApi\Model\ReportsGet200Response|\App\Module\RecruitisApi\Model\ReportsGet400Response, HTTP status code, HTTP response headers (array of strings)
     */
    public function reportsGetWithHttpInfo($version, $lists = null, $date_from = null, $date_to = null, string $contentType = self::contentTypes['reportsGet'][0])
    {
        $request = $this->reportsGetRequest($version, $lists, $date_from, $date_to, $contentType);
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\App\Module\RecruitisApi\Model\ReportsGet200Response' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\App\Module\RecruitisApi\Model\ReportsGet200Response' !== 'string') {
                            try {
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\App\Module\RecruitisApi\Model\ReportsGet200Response', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                case 400:
                    if ('\App\Module\RecruitisApi\Model\ReportsGet400Response' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\App\Module\RecruitisApi\Model\ReportsGet400Response' !== 'string') {
                            try {
                                $content = json_decode($content, false, 512, JSON_THROW_ON_ERROR);
                            } catch (\JsonException $exception) {
                                throw new ApiException(
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\App\Module\RecruitisApi\Model\ReportsGet400Response', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            }

            $returnType = '\App\Module\RecruitisApi\Model\ReportsGet200Response';
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\App\Module\RecruitisApi\Model\ReportsGet200Response',
                ...
                case 400:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\App\Module\RecruitisApi\Model\ReportsGet400Response',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     */
    public function reportsGetAsync($version, $lists = null, $date_from = null, $date_to = null, string $contentType = self::contentTypes['reportsGet'][0])
    {
        return $this->reportsGetAsyncWithHttpInfo($version, $lists, $date_from, $date_to, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function reportsGetAsyncWithHttpInfo($version, $lists = null, $date_from = null, $date_to = null, string $contentType = self::contentTypes['reportsGet'][0])
    {
        $returnType = '\App\Module\RecruitisApi\Model\ReportsGet200Response';
        $request = $this->reportsGetRequest($version, $lists, $date_from, $date_to, $contentType);
     ...
     */
    public function reportsGetRequest($version, $lists = null, $date_from = null, $date_to = null, string $contentType = self::contentTypes['reportsGet'][0])
    {

        // verify the required parameter 'version' is set
        if ($version === null || (is_array($version) && count($version) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $version when calling reportsGet'
            );
        }
