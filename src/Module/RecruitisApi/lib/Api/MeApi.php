...
class MeApi
{
     ...
     * @return \App\Module\RecruitisApi\Model\MeGet200Response|\App\Module\RecruitisApi\Model\LoginPut401Response
     */
     ...
     * @throws \App\Module\RecruitisApi\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \App\Module\RecruitisApi\Model\MeGet200Response|\App\Module\RecruitisApi\Model\LoginPut401Response, HTTP status code, HTTP response headers (array of strings)
     */
    public function meGetWithHttpInfo(string $contentType = self::contentTypes['meGet'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\App\Module\RecruitisApi\Model\MeGet200Response' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\App\Module\RecruitisApi\Model\MeGet200Response' !== 'string') {
                            try {
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\App\Module\RecruitisApi\Model\MeGet200Response', []),
            ...
            $returnType = '\App\Module\RecruitisApi\Model\MeGet200Response';
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\App\Module\RecruitisApi\Model\MeGet200Response',
