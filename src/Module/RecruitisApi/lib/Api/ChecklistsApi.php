...
class ChecklistsApi
{
     ...
     * @return \App\Module\RecruitisApi\Model\AnswersAnswerIdChecklistsFlowIdGet200Response|\App\Module\RecruitisApi\Model\LoginPut401Response
     */
     ...
     * @throws \App\Module\RecruitisApi\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \App\Module\RecruitisApi\Model\AnswersAnswerIdChecklistsFlowIdGet200Response|\App\Module\RecruitisApi\Model\LoginPut401Response, HTTP status code, HTTP response headers (array of strings)
     */
    public function answersAnswerIdChecklistsFlowIdGetWithHttpInfo($answer_id, $flow_id, string $contentType = self::contentTypes['answersAnswerIdChecklistsFlowIdGet'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\App\Module\RecruitisApi\Model\AnswersAnswerIdChecklistsFlowIdGet200Response' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\App\Module\RecruitisApi\Model\AnswersAnswerIdChecklistsFlowIdGet200Response' !== 'string') {
                            try {
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\App\Module\RecruitisApi\Model\AnswersAnswerIdChecklistsFlowIdGet200Response', []),
            ...
            $returnType = '\App\Module\RecruitisApi\Model\AnswersAnswerIdChecklistsFlowIdGet200Response';
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\App\Module\RecruitisApi\Model\AnswersAnswerIdChecklistsFlowIdGet200Response',
     ...
     * @param  \App\Module\RecruitisApi\Model\ChecklistsAnswerIdItemItemIdStatePutRequest $checklists_answer_id_item_item_id_state_put_request checklists_answer_id_item_item_id_state_put_request (optional)
     ...
     * @throws \App\Module\RecruitisApi\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return \App\Module\RecruitisApi\Model\ChecklistsAnswerIdItemItemIdStatePut200Response|\App\Module\RecruitisApi\Model\LoginPut401Response
     */
     ...
     * @param  \App\Module\RecruitisApi\Model\ChecklistsAnswerIdItemItemIdStatePutRequest $checklists_answer_id_item_item_id_state_put_request (optional)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['checklistsAnswerIdItemItemIdStatePut'] to see the possible values for this operation
     *
     * @throws \App\Module\RecruitisApi\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \App\Module\RecruitisApi\Model\ChecklistsAnswerIdItemItemIdStatePut200Response|\App\Module\RecruitisApi\Model\LoginPut401Response, HTTP status code, HTTP response headers (array of strings)
     */
    public function checklistsAnswerIdItemItemIdStatePutWithHttpInfo($answer_id, $item_id, $checklists_answer_id_item_item_id_state_put_request = null, string $contentType = self::contentTypes['checklistsAnswerIdItemItemIdStatePut'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\App\Module\RecruitisApi\Model\ChecklistsAnswerIdItemItemIdStatePut200Response' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\App\Module\RecruitisApi\Model\ChecklistsAnswerIdItemItemIdStatePut200Response' !== 'string') {
                            try {
                                $content = json_decode($content, false, 512, JSON_THROW_ON_ERROR);
                            } catch (\JsonException $exception) {
                                throw new ApiException(
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\App\Module\RecruitisApi\Model\ChecklistsAnswerIdItemItemIdStatePut200Response', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                case 401:
            ...
            $returnType = '\App\Module\RecruitisApi\Model\ChecklistsAnswerIdItemItemIdStatePut200Response';
            if ($returnType === '\SplFileObject') {
                $content = $response->getBody(); //stream goes to serializer
            } else {
                $content = (string) $response->getBody();
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\App\Module\RecruitisApi\Model\ChecklistsAnswerIdItemItemIdStatePut200Response',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
