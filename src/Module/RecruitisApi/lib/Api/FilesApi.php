...
class FilesApi
{
    ...
    /**
     * Operation filesHashGet
     *
     * Download a file
     *
     * @param  string[] $hash Hash je rozpoznávací string, díky kterému systém ví, jaký soubor vrátit.  Pokud je parametr &#x60;hash&#x60; zadán jako jednoparametrové pole, vrací se payload jako objekt. Jinak se payload vrací jako pole. (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['filesHashGet'] to see the possible values for this operation
     *
     ...
     * @return \App\Module\RecruitisApi\Model\FilesHashGet200Response|\App\Module\RecruitisApi\Model\JobsIdGet404Response|\App\Module\RecruitisApi\Model\FilesHashGet413Response
     */
    public function filesHashGet($hash, string $contentType = self::contentTypes['filesHashGet'][0])
    {
        list($response) = $this->filesHashGetWithHttpInfo($hash, $contentType);
        return $response;
    }

    /**
     * Operation filesHashGetWithHttpInfo
     *
     * Download a file
     *
     * @param  string[] $hash Hash je rozpoznávací string, díky kterému systém ví, jaký soubor vrátit.  Pokud je parametr &#x60;hash&#x60; zadán jako jednoparametrové pole, vrací se payload jako objekt. Jinak se payload vrací jako pole. (required)
     ...
     * @throws \App\Module\RecruitisApi\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \App\Module\RecruitisApi\Model\FilesHashGet200Response|\App\Module\RecruitisApi\Model\JobsIdGet404Response|\App\Module\RecruitisApi\Model\FilesHashGet413Response, HTTP status code, HTTP response headers (array of strings)
     */
    public function filesHashGetWithHttpInfo($hash, string $contentType = self::contentTypes['filesHashGet'][0])
    {
        $request = $this->filesHashGetRequest($hash, $contentType);
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\App\Module\RecruitisApi\Model\FilesHashGet200Response' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\App\Module\RecruitisApi\Model\FilesHashGet200Response' !== 'string') {
                            try {
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\App\Module\RecruitisApi\Model\FilesHashGet200Response', []),
                ...
                case 413:
                    if ('\App\Module\RecruitisApi\Model\FilesHashGet413Response' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\App\Module\RecruitisApi\Model\FilesHashGet413Response' !== 'string') {
                            try {
                                $content = json_decode($content, false, 512, JSON_THROW_ON_ERROR);
                            } catch (\JsonException $exception) {
                                throw new ApiException(
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\App\Module\RecruitisApi\Model\FilesHashGet413Response', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            }

            $returnType = '\App\Module\RecruitisApi\Model\FilesHashGet200Response';
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\App\Module\RecruitisApi\Model\FilesHashGet200Response',
                ...
                case 413:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\App\Module\RecruitisApi\Model\FilesHashGet413Response',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     */
    public function filesHashGetAsync($hash, string $contentType = self::contentTypes['filesHashGet'][0])
    {
        return $this->filesHashGetAsyncWithHttpInfo($hash, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation filesHashGetAsyncWithHttpInfo
     *
     * Download a file
     *
     * @param  string[] $hash Hash je rozpoznávací string, díky kterému systém ví, jaký soubor vrátit.  Pokud je parametr &#x60;hash&#x60; zadán jako jednoparametrové pole, vrací se payload jako objekt. Jinak se payload vrací jako pole. (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function filesHashGetAsyncWithHttpInfo($hash, string $contentType = self::contentTypes['filesHashGet'][0])
    {
        $returnType = '\App\Module\RecruitisApi\Model\FilesHashGet200Response';
        $request = $this->filesHashGetRequest($hash, $contentType);
    ...
    /**
     * Create request for operation 'filesHashGet'
     *
     * @param  string[] $hash Hash je rozpoznávací string, díky kterému systém ví, jaký soubor vrátit.  Pokud je parametr &#x60;hash&#x60; zadán jako jednoparametrové pole, vrací se payload jako objekt. Jinak se payload vrací jako pole. (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['filesHashGet'] to see the possible values for this operation
     *
     ...
     */
    public function filesHashGetRequest($hash, string $contentType = self::contentTypes['filesHashGet'][0])
    {

        // verify the required parameter 'hash' is set
        if ($hash === null || (is_array($hash) && count($hash) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $hash when calling filesHashGet'
            );
        }


        $resourcePath = '/files/{hash}';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
        ...
        // path params
        if (is_array($hash)) {
            $hash = ObjectSerializer::serializeCollection($hash, 'csv');
        }
        if ($hash !== null) {
